						...
						<script type="text/javascript" src="/common/js/jquery.tinycarousel.js"></script>
						...
						function getTopVideos_HM() {
						  addScriptTag("topVideos_HM", "http://api.brightcove.com/services/library?command=find_playlist_by_id&playlist_id=<?=$playlist_HM?>&video_fields=id%2Cname%2CvideoFullLength%2CvideoStillURL%2CcustomFields&media_delivery=http&token=<?=$token?>", "response_HM");
						}
