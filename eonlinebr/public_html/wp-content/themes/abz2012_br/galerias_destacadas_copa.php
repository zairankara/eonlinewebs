<div id="clients" style="margin-bottom:10px;">
	<div class="entry-utility">
		<h3 style="background-color: #c6e6f9 !important;">FOTOS DO MUNDIAL</h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT copa_mundo_br_1, copa_mundo_br_2, copa_mundo_br_3, copa_mundo_br_4, copa_mundo_br_5 FROM abmGalDestacadas", ARRAY_A);

	
				for($al=1;$al<=5;$al++){
						$id_galeria=$galerias[0]["copa_mundo_br_".$al];
