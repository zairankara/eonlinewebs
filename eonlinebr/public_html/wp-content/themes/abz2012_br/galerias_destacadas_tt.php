<div id="clients" class="galerias_dest_thetrend">
	<div class="entry-utility">
		<h3 style="background-color: <?php echo cat_color($name_cat);?> !important;">ÚLTIMAS GALERIAS</h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT tt_br_1, tt_br_2, tt_br_3, tt_br_4, tt_br_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["tt_br_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>galerias" rel="bookmark" style="color:#fde500; font-size:18px;">Ver mais galerias</a>
						</div>
