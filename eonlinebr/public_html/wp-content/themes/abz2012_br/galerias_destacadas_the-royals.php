<div id="clients" class="galerias_dest_theroyals">
	<div class="entry-utility">
		<h3 style="background-color: <?php echo cat_color($name_cat);?> !important; color:#fff !important;">THE ROYALS - FOTOS </h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT the_royals_br_1, the_royals_br_2, the_royals_br_3, the_royals_br_4, the_royals_br_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["the_royals_br_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>galerias_page/" rel="bookmark" style="color:<?php echo cat_color($name_cat);?> !important; font-size:18px;">Ver mais galerias</a>
						</div>
