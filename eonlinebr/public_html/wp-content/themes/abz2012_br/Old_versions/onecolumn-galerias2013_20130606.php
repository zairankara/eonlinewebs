	...
	max-width: 550px !important;
		...
		<div id="container">
			...
			<div class="cont_one-clumn" style="background-color: #1a1a1a;padding-top: 20px; margin:10px;">
									...
									$url = 'http://adsrv01.eonlinelatinola.com/www/delivery/ajs.php?zoneid=138';
									...
									if($_GET["foto"]!=""){
										...
										if($_GET["foto"]=="0" || $_GET["foto"]==$suma+1){
											header ("Location: http://br.eonline.com/galerias_page/?gallery=$gallery");
									...
									if($_GET["foto"]%3==0 && $_GET["foto"]!="" && $hay_=="1"){?>
											...
											<h1 style="color:#fff; margin-left: 25px !important;"><?=$name_gallery?></h1>										<div class="banner_slider">
											<script type='text/javascript'><!--// <![CDATA[
											    OA_show(138);
											// ]]> --></script><noscript>
											<a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=e4affa3'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=138&amp;n=e4affa3' /></a>
											</noscript>
