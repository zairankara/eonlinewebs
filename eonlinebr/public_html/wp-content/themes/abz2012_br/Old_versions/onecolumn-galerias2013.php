										          ...
										          <?foreach($galleries as $image){?>
														...
														<div class="set">
												            ...
												            <div class="imgCaption">
																	...
																	<p><a href="https://twitter.com/share" class="twitter-share-button" data-url="<?=$urlImg?>" data-text="<?=$tit_img?>" data-via="eonlinebrasil" data-lang="pt" data-dnt="true">Twittear</a></p>
																	...
																	<div style="margin-bottom:30px;">
																		...
																		<div class="fb-comments" data-href="<?=$urlImg?>" data-width="400" data-colorscheme="dark" data-num-posts="2"  ></div>
																	</div>
												            </div>
												            <div class="imgImage">
												            	<img src="<?=$urlImg;?>" title="<?=$tit_img?>" alt="<?=$tit_img?>" /><br/>
												            	<h2 style="margin-top: 10px; margin-bottom:5px; color:<?php echo cat_color(fotos);?>; text-transform: none; letter-spacing:normal; font-family: 'Din Web Condensed', 'Arial Narrow', Sans-Serif; text-rendering: optimizeLegibility;color:#fff; font-size:18px; line-height:1.2 !important;"><?=$tit_img?><br/><?=utf8_decode(html_entity_decode($desc_img));?></h2>
														        <h2 style="color:<?php echo cat_color(fotos);?>; text-transform: none; letter-spacing:normal; font-family: 'Din Web Condensed', 'Arial Narrow', Sans-Serif; text-rendering: optimizeLegibility;color:#fff; font-size:18px; line-height:1.2 !important;"><a href="/<?=$var_con[90];?>/" style="color:#fff;">Ver mais galerias</a></h2>
