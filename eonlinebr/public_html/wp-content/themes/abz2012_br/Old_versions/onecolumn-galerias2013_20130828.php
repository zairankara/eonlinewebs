												...
												if($contador_fotos==$actual){?>
														...
														<div class="slide_foto">
															...
															if($vecUrl[1]=="")
															{
																	...
																	$urlImg2=$var_con[1].$image["path"]."/".$image["filename"]."?id=br";
															}else{
																	$urlImg="http://".$vecUrl[1];
																	$urlImg2="http://".$vecUrl[1]."?id=br";
													...
													<div class="share_foto">
														...
														<p><a href="https://twitter.com/share" class="twitter-share-button" data-url="<?=$urlImg?>" data-text="<?=$alttext?>" data-via="eonlinebrasil" data-lang="pt" data-dnt="true">Twittear</a></p>
														...
														<div style="margin-bottom:30px;">
															...
															<fb:comments href="<?=$urlImg2;?>" width="350" num_posts="5" colorscheme="dark"></fb:comments >
