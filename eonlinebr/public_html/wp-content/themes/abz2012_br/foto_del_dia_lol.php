<?if(is_category( "lol" )){?>
	<div class="popular-posts "><h3 class="widget-title" style="text-transform:uppercase; color:<?php echo cat_color('lol');?>">MEME DO DIA</h3></div>

	<ul class="sidebar_300" style="display:block;margin-bottom:8px;">
		<?
		$querystring_meme= "tag=meme-do-dia&showposts=1&order=DESC"; //ordenacion ascendente por fecha
