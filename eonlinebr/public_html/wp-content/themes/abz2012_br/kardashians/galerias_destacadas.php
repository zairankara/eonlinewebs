<div id="clients" style="background-color:#000000;" class="galerias_dest_thekardashians">
	...
	$galerias = $mydb2->get_results("SELECT tk_br_1, tk_br_2, tk_br_3, tk_br_4, tk_br_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["tk_br_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>galerias" rel="bookmark" style="color:#ff9c00; font-size:18px;">Ver mais galerias</a>
						</div>
				</div>
