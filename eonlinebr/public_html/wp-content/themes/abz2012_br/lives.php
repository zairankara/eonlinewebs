					<!-- LIVESTREAMING-->
						...
						$abmLivesRows_url = $mydb2->get_var("SELECT url_br FROM abmLives WHERE 1");
						...
						if($abmLivesRows==1 && $abmLivesRows_is_category=="home"){?>
							<div style="margin-left:20px; margin-top:10px; margin-bottom:10px; width:620px; height:<?=$height+10;?>px;border:5px solid #000;">
								<iframe src="<?=$abmLivesRows_url?>?f=99" width="615" height="<?=$height?>" scrolling="no" frameborder="0" allowtransparency="allowtransparency"></iframe>
							</div>
					...
					<!-- LIVETWEETING-->
						<?if (is_home() && $i==0 && $_SESSION["liveT"]=="gr" && $abmLivesRows_is_category=="home"){?>
							    <div style="margin-left:20px; margin-top:10px; margin-bottom:10px; width:620px; height:440px; background: #E4E4E4 url(http://la.eonline.com/argentina/wp-content/themes/abz2012/images/ultimas_noticias.jpg) no-repeat bottom; border:5px solid #000;">
										 <div style="margin:5px 0; width:440px; height:430px; overflow:hidden;"><iframe src="http://br.eonline.com/experience/redcarpetseason/oscar2014/timeline.php" width="440" height="430" scrolling="no" frameborder="0" allowtransparency="allowtransparency" style="width: 440px !important;"></iframe></div>
								</div>
						<?}?>
					<!-- / LIVETWEETING-->