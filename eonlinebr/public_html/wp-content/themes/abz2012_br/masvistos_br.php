<h3 style="margin:10px 0 0 0;"><img src="<?php echo esc_url( get_template_directory_uri() )?>/images/cab_masleidas_br.png" alt="más leídas" title="más leídas"></h3>
	...
	foreach ($mas_leidos as $key) {
		...
		<div class="client-slice" style="background-color:#fff; margin: 0 5px;">
				...
				<div class='tit_post' style="width: 270px;margin-left:0;">
					...
					<a href="<?php echo home_url();?>/<?=$key["post_name"]?>" title="<?=$key["post_title"]?>">
