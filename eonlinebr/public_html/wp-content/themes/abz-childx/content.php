                    ...
                    <div class="contenido_nota_ch">
                        ...
                        <?php if ('post' == get_post_type()) { ?>
                            <div class="entry-meta">
                                <time class="entry-date published hide"><span class="date updated "><?php echo get_the_date( 'Y-m-d H:i:s' ); ?></span></time>
                                <time class="pull-left" ><span class="glyphicon glyphicon-time"></span>&nbsp;<?php echo the_time(); ?></time>
