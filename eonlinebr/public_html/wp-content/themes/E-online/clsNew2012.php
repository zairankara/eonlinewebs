...
*/
	...
	foreach ($testRows as $row) {
		...
		if($titulo!=$titulo1 && $can>0)
			echo("<div style='padding: 5px; color: #5178bc; font: 10px/22px Tahoma, Arial; border-bottom:1px solid #001534; width:90%; margin:0 5px'>".$hora."h ".$min." <strong>   <span  style='color: #fff;'>".$titulo."</span></strong></div>");
