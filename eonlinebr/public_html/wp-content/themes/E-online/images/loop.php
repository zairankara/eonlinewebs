...
<?php endif; ?>
			...
			<div class="entry-utility">
				...
				<span class="comments-link"><?php comments_popup_link( __( 'Comentar', 'twentyten' ), __( '1 Comment', 'twentyten' ), __( '% Comments', 'twentyten' ) ); ?></span>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'twentyten') ) ) : ?>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( '<div class="leer_mas"></div>', 'twentyten' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
