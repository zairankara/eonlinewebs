...
<!-- AddThis Button END -->
				...
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Entrada anterior link', 'twentyten' ) . '</span> Retornar' ); ?></div>
					<div class="nav-next"><?php next_post_link( '%link', '+ Informação <span class="meta-nav">' . _x( '&rarr;', 'Proxima entrada link', 'twentyten' ) . '</span>' ); ?></div>
				</div><!-- #nav-below -->
