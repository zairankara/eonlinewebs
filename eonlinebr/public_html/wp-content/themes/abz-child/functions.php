...
function translate_text($translated) {
     $translated = str_ireplace('día', 'dia',  $translated);
...
function que_masthead_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-970x250' class='publicidad masthead_banner' >
		...
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-970x250'); });
		</script>
		</div>";
    return $script_div;
}
...
function que_doublebox_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-300x600' class='publicidad' style='margin-bottom: 10px;'>
		<script type='text/javascript'>
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-300x600'); });
		</script>
		</div>";
    return $script_div;
}
...
function que_300x100_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-300x100' class='publicidad' style='margin:10px 5px;'>
		<script type='text/javascript'>
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-300x100'); });
		</script>
		</div>";
    return $script_div;
}
...
function que_billboard_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-970x31' class='publicidad billboardAD'>
			<script type='text/javascript'>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-970x31'); });
			</script>
			</div>";
    return $script_div;
}
...
function que_pushdown_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-970x90' class=' publicidad pushdownAD'>
			<script type='text/javascript'>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-970x90'); });
			</script>
			</div>";
    return $script_div;
}
...
function que_floating_es($width,$height,$datos){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-".$width."x".$height."' class='floating publicidad'>
				...
				<div class='floating_content_table'>
					<script type='text/javascript'>
					googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-".$width."x".$height."".$adicional."'); });
					</script>
				</div>
		</div>";
    return $script_div;
...
function que_floorAd_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-floorad' class='publicidad'>
			<script type='text/javascript'>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-floorad'); });
			</script>
			</div>";
    return $script_div;
}
...
function que_floating_3ros_es(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-floating_3ros' class='publicidad'>
			<script type='text/javascript'>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-floating_3ros'); });
			</script>
			</div>";
    return $script_div;
}
...
function url_resize_submenu($Html_ch){
    ...
    if($posPNG!== FALSE || $posPNG!== $posGIF){
        ...
        $url="http://images.eonline.com/resize/145/145/$image2";
    }
    return $url;
...
function es_Redcarpet()
{
    $cat = get_term_by('name', single_cat_title('',false), 'category');
    $catSlug=$cat->slug;
    if($catSlug=="tapetevermelho" || $catSlug=="goldenglobe" || $catSlug=="sag" || $catSlug=="grammy" || $catSlug=="oscar" || $catSlug=="emmy" || $catSlug=="teenchoice" || $catSlug=="baftaawards" || $catSlug=="latinbillboard"){
        return $catSlug;
    }else{
        return false;
    }
...
function quien_es_skin(){
    ...
    $script_div="<div id='div-gpt-ad-".$postSlug."-2000x1000' class='skin'><div class='skin_content_table publicidad' >
		<script type='text/javascript'>
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$postSlug."-2000x1000'); });
		</script></div></div>";
    return $script_div;
}
function que_cat_es($cat,$w,$h,$datos){
    ...
    $script_div="
		<script type='text/javascript'>
		googletag.cmd.push(function() { googletag.display('div-gpt-ad-".$cat."-".$w."x".$h."".$adicional."'); });
		</script>";
    return $script_div;
}
...
/* 2016 */
                ...
                foreach($images as $image){
                    ...
                    $armo_cadena[$i][]="
                        <div class='cta__thumb'>
                            <a href='".home_url( '/' )."galerias_page?gallery=".$id_galeria."' rel='bookmark' class='image-button image-button--gallery clearfix'></a>
                            <a href='".home_url( '/' )."galerias_page?gallery=".$id_galeria."'><img src='". url_resize_sola($urlImg,260)."'  class='img-responsive'/></a>
                        </div>";

                    $k++;
                }
                $cadena[] = "<div class='cta'>".implode("",$armo_cadena[$i])." <div class='cta__text'> <h2 class='cta__title'>$title_gal</h2> <p><strong>$title</strong></p></div><div class='bot_vermas'><a href='".home_url( '/' )."galerias_page/?gallery=".$id_galeria."' class='vermais' rel='bookmark'>Ver galeria relacionada</a></div>";
                $contenido = str_replace($matches[0], $cadena, $content);
                $i++;
            }
        }else{
    ...
    function dynamictime() {
        ...
        $mytime = time() - $time;
        if($mytime < 60){
            $mytimestamp = __('Agora');
        }else{
            $mytimestamp = sprintf(__('Faz %s'), human_time_diff_abz($time));
        }
        return $mytimestamp;
    }
