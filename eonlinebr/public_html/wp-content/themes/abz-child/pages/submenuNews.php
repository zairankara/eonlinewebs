							<ul id="Header_NewsSubMenu" class="submenu container col-md-12">
								<?php
								// The Query
								query_posts( 'category_name=enews&posts_per_page=7' );
								...
								while ( have_posts() ) : the_post();
									echo '<li>';
											...
											$image_ch_explode_resize=url_resize_submenu($Html);
