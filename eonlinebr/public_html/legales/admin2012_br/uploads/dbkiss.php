...
/*
	...
	* Secure redirection - no referer header sent - when clicking external links (ex. powered by), so that the location of the dbkiss script on your site is not revaled.
	1.09
...
function powered_by()
{
	?>
		...
		function link_noreferer(link)
		{
			...
			w.document.write("<"+"title>Secure redirection - no referer</title>");
			...
			w.document.write("<"+"h1>Secure redirection - no referer<"+"/h1>");
			...
			w.document.write("<"+"p>In a few seconds you will be redirected or you can click the link (also secure): <"+"a href='javascript:void(0)' onclick='redirect()'>"+link+"<"+"/a><"+"/p>");
