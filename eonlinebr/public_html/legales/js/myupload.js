jQuery(document).ready(function($){
	...
	$(".IMU").each(function(index){
		...
		var idProyecto = "";
		if(typeof(self.attr("idProyecto"))!="undefined")
			idProyecto = self.attr("idProyecto");
		...
		var scriptData = "'action':'upload', 'path':'"+self.attr('path')+"', 'idProyecto':'"+self.attr('idProyecto')+"', 'PHPSESSID':'"+sessionId+"'";
