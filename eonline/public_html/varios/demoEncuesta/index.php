...
function enviar_variables(){
	...
	if(selected_val>=0 || selected_val<=2)
	{
		...
		$.post("http://la.eonline.com/varios/demoEncuesta/mi_poll.php",{poll:'1', feed:var_feed, variable:selected_val},function(respuesta){
...
<div id="containerPoll">
	<div style="width:300px; height:180px; margin-left:50px;">
		<h1><span style="color:#bcbcbc;">Pregunta: </span>¿Quién es Ryan Lochte?</h1>
		<ul id="poll">
