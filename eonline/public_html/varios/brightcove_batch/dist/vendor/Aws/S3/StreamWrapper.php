 ...
 * a 'produccion://temp' stream to allow seeking to previously read bytes from the
 * stream.
 *
 ...
 * maintain a 'produccion://temp' stream to buffer data written to the stream until
 ...
 * buffered in a "produccion://temp" stream. Append streams will attempt to download
 ...
 *   using a produccion://temp stream buffer
...
class StreamWrapper
{
    ...
    {
        $this->body = new Stream(fopen('produccion://temp', 'r+'));
        return true;
    }
