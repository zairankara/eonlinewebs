...
function getService()
{
  ...
  $service_account_email = 'e-ven-237@e-abz-ga.iam.gserviceaccount.com';
  $key_file_location = '/home/eonline/public_html/varios/JSON/ga-API/GA-4fcf175bc652.p12';

  // Create and configure a new client object.
  $client = new Google_Client();
  $client->setApplicationName("Venezuela");
...
file_put_contents('/home/eonline/public_html/varios/JSON/JSONanalytics/venezuela.json', $jsonData);
?>