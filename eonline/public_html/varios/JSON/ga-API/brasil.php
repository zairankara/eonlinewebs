...
function getService()
{
  ...
  $service_account_email = 'e-bra-371@e-abz-ga.iam.gserviceaccount.com';
  $key_file_location = '/home/eonline/public_html/varios/JSON/ga-API/GA-108a643de06a.p12';

  // Create and configure a new client object.
  $client = new Google_Client();
  $client->setApplicationName("Brasil");
...
file_put_contents('/home/eonline/public_html/varios/JSON/JSONanalytics/brasil.json', $jsonData);
?>