...
$cfg['Servers'][$i]['port']          = '81';          // MySQL port - leave blank for default port
$cfg['Servers'][$i]['socket']        = '';          // Path to the socket - leave blank for default socket
$cfg['Servers'][$i]['connect_type']  = 'tcp';       // How to connect to MySQL server ('tcp' or 'socket')
$cfg['Servers'][$i]['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controluser']   = 'uv0522';          // MySQL control user settings
                                                    // (this user must have read-only
$cfg['Servers'][$i]['controlpass']   = 'zafo468fugir';          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
                                                    // The controluser is also
                                                    // used for all relational
                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     = 'config';    // Authentication method (config, http or cookie based)?
$cfg['Servers'][$i]['user']          = 'uv0522';      // MySQL user
$cfg['Servers'][$i]['password']      = 'zafo468fugir';          // MySQL password (only needed
...
$cfg['Servers'][$i]['controluser']     = 'uv0522';
$cfg['Servers'][$i]['controlpass']     = 'zafo468fugir';
$cfg['Servers'][$i]['auth_type']       = 'config';
$cfg['Servers'][$i]['user']            = 'uv0522';
$cfg['Servers'][$i]['password']        = 'zafo468fugir';
...
$cfg['SQLValidator']['username'] = 'uv0522';      // If you have a custom username, specify it here (defaults to anonymous)
$cfg['SQLValidator']['password'] = 'zafo468fugir';      // Password for username
