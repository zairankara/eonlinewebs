...
if(is_home() || is_search() || is_tag()){
				...
				switch($postSlug){
					...
					case "zonatrendycaracas":
						$name_sectionDFP="Vip_Caracas";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Vip_Caracas/BoxBanner_1', [300, 250], 'div-gpt-ad-zonatrendycaracas-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Vip_Caracas/Header_Chico', [240, 90], 'div-gpt-ad-zonatrendycaracas-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Vip_Caracas/LeaderBoard', [728, 90], 'div-gpt-ad-zonatrendycaracas-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Vip_Caracas/Floating_3ros', 'div-gpt-ad-zonatrendycaracas-floating_3ros').addService(googletag.pubads());";
					break;
					case "epop":
					...
					case "lasopavenezuela":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/BoxBanner_1', [300, 250], 'div-gpt-ad-lasopavenezuela-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Header_Chico', [240, 90], 'div-gpt-ad-lasopavenezuela-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/LeaderBoard', [728, 90], 'div-gpt-ad-lasopavenezuela-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Floating_3ros', 'div-gpt-ad-lasopavenezuela-floating_3ros').addService(googletag.pubads());";
					break;
					case "programas":
					...
					case "fotos-venezuela":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/BoxBanner_1', [300, 250], 'div-gpt-ad-fotos-venezuela-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Header_Chico', [240, 90], 'div-gpt-ad-fotos-venezuela-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/LeaderBoard', [728, 90], 'div-gpt-ad-fotos-venezuela-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Floating_3ros', 'div-gpt-ad-fotos-venezuela-floating_3ros').addService(googletag.pubads());";
					break;
					case "galerias":
					...
					case "videos-2":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Videos/Header_Chico', [240, 90], 'div-gpt-ad-videos-2-240x90').addService(googletag.pubads());
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Videos/Skin', [2000, 1000], 'div-gpt-ad-videos-2-2000x1000').addService(googletag.pubads());";
					break;
					case "app":
						$name_sectionDFP="Homepage";
					...
					case "contacto":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-contacto-300x250-1').addService(googletag.pubads());
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Skin', [2000, 1000], 'div-gpt-ad-contacto-2000x1000').addService(googletag.pubads());";
					break;
					case "politicas-de-privacidad":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-politicas-de-privacidad-300x250-1').addService(googletag.pubads());
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Skin', [2000, 1000], 'div-gpt-ad-politicas-de-privacidad-2000x1000').addService(googletag.pubads());";
					break;
					case "terminos-de-uso":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-terminos-de-uso-300x250-1').addService(googletag.pubads());
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Skin', [2000, 1000], 'div-gpt-ad-terminos-de-uso-2000x1000').addService(googletag.pubads());";
					break;
					case "politica-de-remocion":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-politica-de-remocion-300x250-1').addService(googletag.pubads());
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Skin', [2000, 1000], 'div-gpt-ad-politica-de-remocion-2000x1000').addService(googletag.pubads());";
					break;
					case "yosoyelartista":
						$name_sectionDFP="Homepage";
