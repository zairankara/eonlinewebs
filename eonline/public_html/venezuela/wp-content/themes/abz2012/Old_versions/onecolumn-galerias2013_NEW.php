	...
	max-width: 550px !important;
		...
		<div id="container">
			...
			<div class="cont_one-clumn" style="background-color: #1a1a1a;padding-top: 20px; margin:10px;">
									...
									$url = 'http://adsrv01.eonlinelatinola.com/www/delivery/ajs.php?zoneid=136';
									$h = file_get_contents($url, true);
									$resultado = strpos($h, "http://adsrv01.eonlinelatinola.com/www/");

									if($resultado !== FALSE && $gallery=="8554"){
										$hay_="1";
									}else {
										$hay_="0";
									}
									...
									if($_GET["foto"]!=""){
										...
										if($_GET["foto"]=="0" || $_GET["foto"]==$suma+1){
											header ("Location: http://la.eonline.com/argentina/galerias?gallery=$gallery");
									...
									/*foreach($galleries as $image_test)
										{
												echo "<br>".$image_test["filename"];
										}*/


									if($_GET["foto"]%3==0 && $_GET["foto"]!="" && $gallery=="8554"){?>
										...
										<div class="banner_slider">
											<script type='text/javascript'><!--// <![CDATA[
											    OA_show(136);
											// ]]> --></script><noscript>
											<a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=d6e1d77'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=136&amp;n=d6e1d77' /></a>
											</noscript>
									...
									<?}else{
										...
										foreach($galleries as $image)
										{
											...
											//echo($contador_fotos);
												...
												//echo("<br><br>SELECTED:$contador_fotos");
												//print_r($galleries);	
													//echo "<br>".$image["filename"];
