...
<?
/*$url_texto=str_replace("venezuela/","",$_SERVER["REQUEST_URI"]);
...
$res_mx=http_response('http://la.eonline.com/mexico'.$url_texto);
if($res_mx==1) echo("<link rel='alternate' hreflang='es-mx' href='http://la.eonline.com/mexico".$url_texto."' />");*/
?>
...
$default_img = "/venezuela/wp-content/themes/abz2012/images/generica_blanca.jpg";
...
<script type="text/javascript" src="/varios/modulos_extra/addthis_widget.js#pubid=matibur"></script>
<!-- / ADDTHIS -->
...
<script language="JavaScript" type="text/javascript" src="/varios/modulos_extra/BrightcoveExperiences.js"></script>
...
<script src="/varios/modulos_extra/APIModules_all.js"></script> 
<script type="text/javascript">
...
jQuery(document).ready(function($) {
 ...
 <!--/* ENCUESTA ONLINE  */-->
	...
	<!--/* Defineslots */-->
	<? include(TEMPLATEPATH."/defineslots_venezuela.php");?>
	<!--/* Defineslots */-->
			  ...
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				...
				<div class="menu-header">
					<ul id="menu-principal" class="menu">
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a href="<?php echo home_url( '/' ); ?>pagina/fotos-venezuela" OnMouseOver="this.style.borderColor='<?php echo cat_color('fotos');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('fotos');?>; <?if(is_page('fotos-venezuela')) echo ("border-color:".cat_color('fotos').";");?>">Fotos</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
...
.borde_billboard_banner{
    ...
    if ($cat_alf2==1 || $cat_alf3==1){?>
			...
			.category-alfombraroja #submenu  .items_sponsor{
				background-image: url(<?php echo $var_con[200]; ?>/images/patrocinio_redcarpet_VZ.png);
			}
			</style>
        <div id="submenu">
