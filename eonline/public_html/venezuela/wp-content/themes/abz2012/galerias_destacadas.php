<div id="clients" style="background-color:#000 !important;" class="galdest">
	...
	$galerias = $mydb2->get_results("SELECT vz_1, vz_2, vz_3, vz_4, vz_5 FROM abmGalDestacadas", ARRAY_A);
	
	
				for($al=1;$al<=5;$al++){
						
						$id_galeria=$galerias[0]["vz_".$al];

						$galleries = obtener_galerias($id_galeria, "1", "pg.orden", "ASC", NULL);					

						//if($_GET["web"]!="") print_r($galleries);
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>pagina/fotos-venezuela" rel="bookmark" style="color:#ff0099; font-size:18px;">Ver más galerias</a>
						</div>
