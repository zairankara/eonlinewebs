...
?>
		...
		<div class="cont_sidebar">
						...
						<!-- VIP CARACAS -->
							<ul class="xoxo" >
								<?php include("wp-content/themes/E-online/vip_caracas.php"); ?>		
						</ul>
								...
								<div style='height:170px; _height:180px; overflow-y:auto; width:300px; background:#fff; padding-top:10px;'>
											...
											<div style="width:130px; margin-left:5px; padding-bottom:10px; float:left;">
													...
													<tr>
														...
														<A HREF="http://www.eonlineexperiences.com/vip_caracas" target="_blank"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/celebridades/caterina_valentino.jpg" alt="" width="90" border="0" /></A></div></td>
													</tr>
													<tr>
														<td class="mod_chico_programa" style="text-align:center;" ><A HREF="http://www.eonlineexperiences.com/vip_caracas" target="_blank" style="text-decoration:none;">Caterina Valentino</A></td>
													</tr>
													</table>
											</div>
