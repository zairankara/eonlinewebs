...
<?php 
		...
		while ( have_posts() ) : the_post(); ?>
						...
						<?php if ( is_home() && $i==0 ){?>
								...
								<a href="http://la.eonline.com/concursos/chinoynacho/" target="_blank"><img src="<?php bloginfo('template_url')?>/images/chinoynacho_venezuela.jpg" alt="" width="590" height="116" border="0"></a></div>
						<?}?>
						-->
						...
						<?php if ( !is_home() && is_category("oscar") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_oscar_VEN.gif" alt="" width="593" height="63" border="0"></div>
						<?}?>
						-->
					...
					//]]>--></script><noscript><a href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=a5e9e323&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=42&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a5e9e323' border='0' alt='' /></a></noscript>
					</div>
						<?}?>
						<!-- ADSERVER TOPPOST-->
						...
						<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
						 <script type='text/javascript'><!--//<![CDATA[
						   ...
						   if (document.mmm_fo) document.write ("&amp;mmm_fo=1");
						   document.write ("'><\/scr"+"ipt>");
						//]]>--></script><noscript><a href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=aaa4aa76&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=85&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=aaa4aa76&amp;ct0=INSERT_CLICKURL_HERE' border='0' alt='' /></a></noscript>
						</div>
						<?}?>
						 <!--  ADSERVER TOPPOST-->
