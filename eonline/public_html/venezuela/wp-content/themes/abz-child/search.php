                            ...
                            {?>
                                <div id="nav-below" class="navigation clearfix">
                                    ...
                                    if($page_actual<=1 || $page_actual==""){
                                        ...
                                        <div class="nav-next categorygrid__morebutton"><a href="<? echo "http://" . $_SERVER['HTTP_HOST'] . "/".NAMEFEED."/?s=".$_GET["s"]."&pageId=2"?>">+ INFORMACION</a></div>
                                    <?}else{
                                        $proxpag=$page_actual+1;
                                        $antpag=$page_actual-1;?>
                                        <div class="nav-previous categorygrid__morebutton"><a href="<? echo "http://" . $_SERVER['HTTP_HOST'] . "/".NAMEFEED."/?s=".$_GET["s"]."&pageId=".$antpag.""?>">+ REGRESAR</a></div>
                                        <?if($cantidad_posts==10){?><div class="nav-next"><a href="<? echo "http://" . $_SERVER['HTTP_HOST'] . "/".NAMEFEED."/?s=".$_GET["s"]."&pageId=".$proxpag.""?>">+ INFORMACION</a></div><?}?>
                                    <?}?>
                                </div>
                            <?}?>
                        </aside>
