...
<!-- PLAYER DE LA HOME CON PLAYLIST-->
                                    ...
                                    <script src="//players.brightcove.net/96980687001/BkMVIR9Z5l_default/index.min.js"></script></div></div><ol class="vjs-playlist"></ol>
                                    <style>
                                    #playlist_single{
                                        margin: 10px auto;
                                    }
                ...
                <!-- <aside class="widget publicidad">
                    ...
                    <!-- / ADSERVER-->
                        ...
                        <div id="related-single" class="col-md-3 col-xs-12" data-mostrarMobile="0" style="display:none;">
                            <!-- MAS LEIDOS-->
                            <?php
                            $url = '../varios/JSON/JSONanalytics/venezuela.json';
