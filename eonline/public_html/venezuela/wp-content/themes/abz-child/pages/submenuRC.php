                            ...
                            <ul id="Header_RCSubMenu" class="submenu container col-md-12">
                                <li style="max-width: 290px;">
                                    <ul class="nav__subnav--type2">
                                        <li><a href="/venezuela/?s=oscar" class="">OSCAR</a></li>
                                        <li><a href="/venezuela/?s=grammy" class="">GRAMMY AWARDS</a></li>
                                        <li><a href="/venezuela/?s=sag" class="">SAG AWARDS</a></li>
                                        <li><a href="/venezuela/?s=emmy" class="">EMMY AWARDS</a></li>
                                    </ul>
                                </li>
								<?php
								// The Query
