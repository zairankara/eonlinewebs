...
case "glamcam360":
					...
					case "lasopacolombia":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/BoxBanner_1', [300, 250], 'div-gpt-ad-lasopacolombia-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Header_Chico', [240, 90], 'div-gpt-ad-lasopacolombia-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/LeaderBoard', [728, 90], 'div-gpt-ad-lasopacolombia-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Floating_3ros', 'div-gpt-ad-lasopacolombia-floating_3ros').addService(googletag.pubads());";
					break;
					case "zonatrendycolombia":
						$name_sectionDFP="Zona_Trendy";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/BoxBanner_1', [300, 250], 'div-gpt-ad-zonatrendycolombia-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/Header_Chico', [240, 90], 'div-gpt-ad-zonatrendycolombia-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/LeaderBoard', [728, 90], 'div-gpt-ad-zonatrendycolombia-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/Floating_3ros', 'div-gpt-ad-zonatrendycolombia-floating_3ros').addService(googletag.pubads());";
					break;
					case "epop":
					...
					break;
					case "fotos-andes":
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/BoxBanner_1', [300, 250], 'div-gpt-ad-fotos-andes-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Header_Chico', [240, 90], 'div-gpt-ad-fotos-andes-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/LeaderBoard', [728, 90], 'div-gpt-ad-fotos-andes-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Floating_3ros', 'div-gpt-ad-fotos-andes-floating_3ros').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Skin', [2000, 1000], 'div-gpt-ad-fotos-andes-2000x1000').addService(googletag.pubads());";
					break;
					case "galerias":
