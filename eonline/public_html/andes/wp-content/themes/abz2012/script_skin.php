<!-- <script>
    $(function(){
	     var myWidth = 0, myHeight = 0;
	      ...
	      var variable="-10";
	      var variable=((myWidth-iMaxWidthSkin) / 2)-10;
	      ...
	      $('#div-gpt-ad-<?php echo cual_cat_es();?>-720x300').animate({left: variable_floating+ "px"}, {duration: 10});
...
$(document).ready(function() {
 	...
 	function methodToFixLayout( e ) {
	    ...
	    //console.log("iMaxWidthSkin:"+iMaxWidthSkin); 
