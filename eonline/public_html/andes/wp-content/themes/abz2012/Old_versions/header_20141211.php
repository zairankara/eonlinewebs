...
<!-- STYLES -->
		...
		<?php } elseif ( is_category( "amamos-las-pelis" )) {?>
					<!--<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $var_con[200]; ?>/		style_seccion.css" />--><link rel="stylesheet" type="text/css" media="screen" href="<?php echo $var_con[200]; ?>/style_amamos-las-pelis.css" />
	...
	if ($cat_alf2==1 || $cat_alf3==1){?>
	      <style>
			...
			.category-alfombraroja #submenu  .items_sponsor{
				background-image: url(<?php echo $var_con[200]; ?>/images/patrocinio_redcarpet_AN.png);
			}
			</style>
			<div id="submenu">
