	...
	if(is_home() || is_search()  || is_tag()){
				...
				switch($postSlug){
					...
					case "cambiame-el-look":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-cambiame-el-look-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-cambiame-el-look-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Floating_3ros', 'div-gpt-ad-cambiame-el-look-floating_3ros').addService(googletag.pubads());";
					break;
					case "wild-on":
