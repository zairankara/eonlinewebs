...
if($gallery!=""){
    ...
    exit('<span class="alert alert-danger" style="left: 50%; top: 50%; position: absolute;">No se encuentra la Galeria<br><a href="/andes/pagina/fotos-andes" class="btn btn-default">Volver</a></span>');
}
?>
...
<?php
    if($gallery==24367){
        echo("<a href='https://www.opticalia.co/' target='_blank' class='logo_patrocinio'><img src='http://la.eonline.com/varios/anunciantes/opticalia/opticalia_0.png' width='180' height='75'></a>");
     }
    ?>
