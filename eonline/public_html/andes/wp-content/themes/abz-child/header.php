...
<!--[if gt IE 8]><!--> <html class="no-js" lang="es-419"> <!--<![endif]-->
	<head>
        ...
        if(is_single()){
            ...
            <meta name="description" content="<?php echo $metadescription;?>. <?php echo $title_site?>" />
            <meta name="abstract" content="<?php echo $metadescription;?>. <?php echo $title_site?>" />
            ...
            <meta property="og:description" content="<?php echo $metadescription;?>. <?php echo $title_site?>" />

            <!--<meta itemprop="name" content="<?php echo $title_post;?>"/>
            <meta itemprop="image" content="<?php echo $primera_img ;?>" />
            <meta itemprop="description" content="<?php echo $metadescription;?>. <?php echo $title_site?>" />
        ...
        <?php } elseif(is_category()||is_tag()||is_page()) { ?>
            ...
            <?php if(!is_page("galerias")){ // las escribo en la page de galerias con los datos de la primera?>
                ...
                <?php if(is_page("videos-2")){
                    ...
                    <meta property="og:url" content="http://la.eonline.com/<?php echo $name_feed?>/pagina/videos-2/?id=<?php echo $videoID; ?>"/>
            ...
            <?}else{?>
                ...
                <meta property="og:title" content="<?php echo $galleries_GET[0]["title_gal"]?>" />
                <meta property="og:description" content="<?php echo $titulo?>" />
                <meta property="og:image" content="<?php echo $vecUrl?>" />
            <?}?>
        ...
        <script type='text/javascript'>
         googletag.cmd.push(function() {
                if(isMobile()){
                    <?php include(STYLESHEETPATH."/pages/defineslots_andes_dynamic_mobile.php"); ?>
                }else{
                    <?php include(STYLESHEETPATH."/pages/defineslots_andes_dynamic.php"); ?>
                }
    ...
    <body id="andes" <?php body_class(); ?> <?php if($title_post) echo ('data-title="'. utf8_decode($title_post).'"');?>  <?php echo "data-slug='".que_section_es()."'";?>>
