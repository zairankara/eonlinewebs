...
?>
		...
		<!--personalizacion-->
            ...
            <?}elseif(is_single()){?>
                ...
                <script async src="/common/feeds/single_an.min.js"></script>
                
                <script async>

                jQuery(document).ready(function($) {
                    //video para la nota de tresemme
                    
                    var deviceAgent = navigator.userAgent.toLowerCase();
                    var agentID = deviceAgent.match(/(iphone|ipod|ipad)/);
                    console.log(agentID);
                    
                    //cambiar id post y id youtube  830189
                    if( $( 'body' ).hasClass( 'postid-870384' ) ){
                        var IDYOUTUBE="kEuuqSmZALc";
                        if (agentID) {
                            //ipad y iphone
                            jQuery("#playlist_single").before( '<a href="youtube://'+IDYOUTUBE+'" style="overflow: hidden; position: relative; display: block;"><div style="background: url(http://la.eonline.com/common/imgs/play_center3.png) center center no-repeat;  width: 100%; height: 100%;  position: absolute; top: 0; left: 0; z-index: 10;"></div><img src="https://img.youtube.com/vi/'+IDYOUTUBE+'/hqdefault.jpg"/></a>' );
                        }else{
                            //desktop y android
                            jQuery("#playlist_single").before( '<iframe width="560" height="315" src="https://www.youtube.com/embed/'+IDYOUTUBE+'" frameborder="0" allowfullscreen></iframe>' );
                        }
                     }else if( $( 'body' ).hasClass( 'postid-893708' ) ){
                        var IDYOUTUBE="x1yEt7lL-3w";
                        if (agentID) {
                            //console.log("ipad y iphone");
                            //ipad y iphone
                            jQuery("#playlist_single").before( '<a href="youtube://'+IDYOUTUBE+'?utm_campaign=campa%C3%B1a-noviembre&utm_source=youtube&utm_medium=cpv&utm_term=youtube&utm_content=video-tunning" style="overflow: hidden; position: relative; display: block;"><div style="background: url(http://la.eonline.com/common/imgs/play_center3.png) center center no-repeat;  width: 100%; height: 100%;  position: absolute; top: 0; left: 0; z-index: 10;"></div><img src="https://img.youtube.com/vi/'+IDYOUTUBE+'/hqdefault.jpg"/></a>' );
                        }else{
                            //desktop y android
                            //console.log("desktop y android");
                            jQuery("#playlist_single").before( '<iframe width="560" height="315" src="https://www.youtube.com/embed/'+IDYOUTUBE+'?utm_campaign=campa%C3%B1a-noviembre&utm_source=youtube&utm_medium=cpv&utm_term=youtube&utm_content=video-tunning" frameborder="0" allowfullscreen></iframe>' );
                        }
                    }else if( $( 'body' ).hasClass( 'postid-874160' ) ){
                        var IDYOUTUBE="5SJJIL--t20";
                        if (agentID) {
                            //console.log("ipad y iphone");
                            //ipad y iphone
                            jQuery("#playlist_single").before( '<a href="youtube://'+IDYOUTUBE+'" style="overflow: hidden; position: relative; display: block;"><div style="background: url(http://la.eonline.com/common/imgs/play_center3.png) center center no-repeat;  width: 100%; height: 100%;  position: absolute; top: 0; left: 0; z-index: 10;"></div><img src="https://img.youtube.com/vi/'+IDYOUTUBE+'/hqdefault.jpg"/></a>' );
                    ...
                    }else if( $( 'body' ).hasClass( 'postid-883880' ) ){
                        var IDYOUTUBE="FY6BXzY_2hw";
                        if (agentID) {
                            //console.log("ipad y iphone");
                            //ipad y iphone
                            jQuery("#playlist_single").before( '<a href="youtube://'+IDYOUTUBE+'" style="overflow: hidden; position: relative; display: block;"><div style="background: url(http://la.eonline.com/common/imgs/play_center3.png) center center no-repeat;  width: 100%; height: 100%;  position: absolute; top: 0; left: 0; z-index: 10;"></div><img src="https://img.youtube.com/vi/'+IDYOUTUBE+'/hqdefault.jpg"/></a>' );
                    ...
                    }else if( $( 'body' ).hasClass( 'postid-887907' ) ){
                        var IDYOUTUBE="FY6BXzY_2hw";
                        if (agentID) {
                            //console.log("ipad y iphone");
                            //ipad y iphone
                    ...
                    }else if( $( 'body' ).hasClass( 'postid-878751' ) ){
                        var IDYOUTUBE="OTPldOjmcvY";
                        if (agentID) {
                            //console.log("ipad y iphone");
                            //ipad y iphone
                            jQuery("#playlist_single").before( '<a href="youtube://'+IDYOUTUBE+'" style="overflow: hidden; position: relative; display: block;"><div style="background: url(http://la.eonline.com/common/imgs/play_center3.png) center center no-repeat;  width: 100%; height: 100%;  position: absolute; top: 0; left: 0; z-index: 10;"></div><img src="https://img.youtube.com/vi/'+IDYOUTUBE+'/hqdefault.jpg"/></a>' );
