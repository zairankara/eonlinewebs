...
<?php 
		...
		while ( have_posts() ) : the_post(); ?>
						...
						<!-- <?php if ( is_home() && $i==0 ){?>
								...
								<a href="http://www.eonlineexperiences.com/avengers/LA/" target="_blank"><img src="<?php bloginfo('template_url')?>/images/comunes/toppost_AND.jpg" alt="" width="590" height="116" border="0"></a></div>
						<?}?>-->
						...
						?>
								<?php if (is_home() && $i==0 ){?>
										  ...
										  <div style="z-index:1; margin-left:10px; margin-bottom:10px; width:590px; height:172px; background: url(http://la.eonline.com/andes/wp-content/themes/E-online/images/comunes/counter_nuevo.jpg) no-repeat; border:0px solid red; position:relative; ">
						...
						<?php if ($i==0 ){?>
								...
								<script type='text/javascript'><!--// <![CDATA[
								    OA_show(40);
								// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=66f142f'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=40&amp;n=66f142f' /></a></noscript>
								</div>
						<?}?>
						 <!--  ADSERVER TOPPOST-->
						...
						<div style="margin-top:5px; margin-left:10px; margin-bottom:5px">
						 <script type='text/javascript'><!--// <![CDATA[
						    OA_show(83);
						// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=55b5be8'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=83&amp;n=55b5be8' /></a></noscript>
						</div>
						<?}?>
						 <!--  ADSERVER TOPPOST-->
							...
							<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<div class="entry-utility">
									<?php if ( count( get_the_category() ) ) : ?>
												...
												<?} elseif ( in_category('londres2012')) {?>
													<h6>
														<?php echo get_the_category_list( ', ' ); ?>
													</h6>
