...
?>
				...
				<div id="footer-row" class="site-footer">
                    ...
                    <div id="footer" class="col-md-12">
                        ...
                        <div class=" col-md-2 col-md-push-8 col-xs-6">
                            <a href="http://www.enowlatino.com" target="_blank" rel="noopener" class="pull-right"><img src="/common/imgs/logoEnow.png" class="img-responsive"> </a>
                        </div>

                        <!-- links Pie -->
                        <div class="links_pie col-md-8 col-md-pull-2 col-xs-12 text-center">
                            <div class="ad_sales"><a href="http://enowlatino.com/" rel="noopener" target="_blank" class="menu-item-a" >E Now Latino</a>
                        ...
                        <div class="abz"><a href="http://www.abzcomunicacion.com" target="_blank" rel="noopener">ABZ Diseño y Comunicación: Diseño y desarrollo de sitios web, marketing digital y BTL.</a></div>
		...
		<!--personalizacion-->
            ...
            <?}elseif( is_page("fotos-argentina") ){?>
            ...
            <?}elseif(is_single()){?>
                ...
                <script async src="/common/feeds/single_ar.min.js"></script>
        ...
        jQuery(document).ready(function($) {
        	...
        	//jQuery("#google_ads_iframe_/8877/Argentina/Homepage/Billboard_0").height(jQuery("#200_216_html_expanding_0").height());
...
<!--
<script data-device="1" type="text/javascript">var SC_RumID = 3979;</script><script type="text/javascript" async src="https://www.statuscake.com/App/RUM/embed.js" data-device="1" ></script>
-->
<!-- CodeBasic Omniture-->
...
<!-- TAGS CODE mindshareworld.com //jose pidio sacar 6/7 -->
...
<!-- Hotjar Tracking Code for la.eonline.com/argentina/ ABZ test-->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:754445,hjsv:6};
