...
<!--[if gt IE 8]><!--> <html class="no-js" lang="es-AR"> <!--<![endif]-->
	<head>
        ...
        <link rel='dns-prefetch' href='//la.eonline.com' />
        ...
        <link rel='dns-prefetch' href='//brightcove.vo.llnwd.net' />
        <link rel='dns-prefetch' href='//c.brightcove.com' />
        <link rel='dns-prefetch' href='//edge.api.brightcove.com' />
        <link rel='dns-prefetch' href='//metrics.brightcove.com' />
        <link rel='dns-prefetch' href='//players.brightcove.net' />
        <link rel='dns-prefetch' href='//connect.facebook.net' />
        <link rel='dns-prefetch' href='//elatinar.112.2o7.net' />
        <link rel='dns-prefetch' href='//images.eonline.com' />
        ...
        <!-- FACEBOOK OPENGRAPH -->
        <meta property="fb:pages" content="78874157277" />
        ...
        <?php } elseif(is_category()||is_tag()||is_page()) { ?>
            ...
            }elseif(is_page("efitness")){
                $title_site="Efitness | ".$feed_site;
                $description_site="Catalina Aristizabal nos da todos los tips para tener una vida fitness.";
            }
        ...
        <!-- FONT-FACE -->
        <link href='https://fonts.googleapis.com/css?family=Lato:400,700,300%7COswald:400,300,700' rel='stylesheet' type='text/css'>        
        <!-- / FONT-FACE -->
        ...
        <!--save in body device-->
        <script async src="/common/js/device.min.js"></script>
        ...
        <script type='text/javascript'>
         googletag.cmd.push(function() {
                if(isMobile()){
                    <?php include(STYLESHEETPATH."/pages/defineslots_argentina_dynamic_mobile.php"); ?>
                }else{
                    <?php include(STYLESHEETPATH."/pages/defineslots_argentina_dynamic.php"); ?>
                }

                //googletag.pubads().enableSyncRendering();
                googletag.pubads().enableSingleRequest();
                googletag.pubads().collapseEmptyDivs();
                //googletag.pubads().setForceSafeFrame(true); //.setForceSafeFrame(true)
        ...
        <script async src="/varios/omniture/pagescroll.js" data-device="1"></script>
        <!-- / CodeBasic PageScroll Omniture-->
    ...
    <body id="argentina" <?php body_class(); ?> <?php if($title_post) echo ('data-title="'. utf8_decode($title_post).'"');?>  <?php echo "data-slug='".que_section_es()."'";?>>
                        ...
                        <div id="NavR_Header_MainContent" class="NavR_Header_MainContent">
                            <div class="hidden-xs visible-sm visible-md visible-lg">
                                <div id="NavR_Header_topItemBlock" class="NavR_Header_topItemBlock">
                                    <a href="http://www.enowlatino.com/" rel="noopener" target="_blank" class="boton_enow">EPISODIOS COMPLETOS</a>
                                ...
                                <div id="NavR_Header_Search_Action" class="NavR_Header_Search_Action" itemscope itemtype="http://schema.org/WebSite">
                                    <meta itemprop="url" content="http://la.eonline.com/argentina"/>
