...
<?php //get_sidebar('left'); ?>
                ...
                <aside id="menu-tabs" class="row hidden-sm hidden-md hidden-lg text-center">
                   <a href="#" class="col-xs-4">NOTICIAS</a>
                    <a href="<?php echo home_url( '/' ); ?>pagina/fotos-argentina" class="col-xs-4">FOTOS</a>
                        ...
                        <script type="text/javascript" data-device="1" id="script_videos_inhome">
                                ...
                                function ejecutarVIDEOS(status){
                                    ...
                                    if(status==1){
                                        ...
                                        jQuery.ajax({
                                            type: "GET",
                                            url: "/common/videos_inhome/videos_inhome_2017_ar.php",
                ...
                <div class="col-xs-12 col-lg-<?php echo $main_column_size;?> content-area" id="main-column" data-sticky_column>
                        ...
                        <main id="main" class="site-main" role="main">
                            ...
                            <aside class="grid effect-5" id="grid" >
                                ...
                                <!-- kimye -->
                                <!--<article class="col-xs-12 col-sm-4 grid-item"><a href="/<?php echo NAMEFEED; ?>/tag/kimye/"><img src="/varios/assets/variete/kimye.jpg" class="img-responsive"></a></article>-->
                                <!-- / kimye -->
                                ...
                                <?php if (have_posts()) { ?>
                                    ...
                                    <?php
                                    //if($_GET["abz"]!="") print_r(have_posts());
                                    $i=1;
                                    // start the loop
                                    while (have_posts()) {
                                        the_post();
                                        ...
                                        //if($i==3) include (STYLESHEETPATH . '/pages/galerias_destacadas.php');
