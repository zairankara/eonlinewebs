...
<?php include (TEMPLATEPATH . '/var_constantes.php'); ?>
		...
		<?php }elseif(is_category()){?>
					...
					<?if(is_category("alfombraroja")){?>
						...
						<div id="loamoloodio">
							<iframe src="http://la.eonline.com/experience/redcarpetseason/loamoloodio/AR/index.php" width="630" height="740" scrolling="no" style="overflow: hidden; border: none;"></iframe>
					...
					<?if(is_category("copadelmundo")){?>
						...
						<div id="copadelmundo">
							<iframe src="http://la.eonline.com/experience/loamoloodioMundial/AR/index.php" width="630" height="830" scrolling="no" style="overflow: hidden; border: none;"></iframe>
						</div>
					...
					<?if(is_category("efashionblogger")){?>
						...
						.zona_banner_toppost{
							background: url(http://la.eonline.com/experience/fashion-blogger-ar/cab.jpg) bottom no-repeat;
							width: 630px;
							height: 47px;
							float: left;
						...
						<div id="nuevo_fashion">
							<iframe src="http://la.eonline.com/experience/fashion-blogger-ar/index.php" width="630" height="730" scrolling="no" style="overflow: hidden; border: none;"></iframe>
						</div>
					...
					echo ("<div class='col_der'>");
						...
						//if(is_category("amamos-las-pelis")) include (TEMPLATEPATH . '/galerias_destacadas_efb.php');
		...
		<?php }else{
			echo ("<div id='col_doble'>");
				$c = 0;
				$cz = 1; 
				while (have_posts() && $cz < 22) : the_post();
