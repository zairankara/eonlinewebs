	...
	<div id="content" role="main">
		...
		<h4>FOTOS</h4>
					...
					foreach ($stack as $album_id){
												...
												foreach($galleries as $gallery_for){
															...
															if($urlImg){?>
																	...
																	<div class="ngg-album">
																		<div class="ngg-albumcontent">
																				<div class="ngg-thumbnail">
																				<a href="/argentina/pagina/galerias?gallery=<?php echo $id_galeria;?>"><img class="Thumb" src="<?php echo $urlImg; ?>" alt="<?php echo ($desc);?>" title="<?php echo ($desc);?>"/></a>
																				<div class="ngg-albumtitle"><a href="/argentina/pagina/galerias?gallery=<?php echo $id_galeria;?>"><?php echo ($desc);?></a></div>
																				</div>
						...
						<div style="clear:both; float:right;width:80px;"><a href="/argentina/pagina/fotos-argentina/?albumID=<?php echo $album_id ?>" style=" font-size:11px; text-decoration:none; margin-right:10px;">Ver más</a></div>
						...
						<?
							...
							?>
							<div class="ngg-clear"> </div>
							<div style="clear:both; float:right;width:80px;"><a href="/argentina/pagina/fotos-argentina/" style=" font-size:11px; text-decoration:none;">Volver</a></div>
						<?
