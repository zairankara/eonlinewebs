												...
												<?php if ( is_archive() || is_search() || is_tag() ) : // Only display excerpts for archives and search. ?>
														...
														<div class="entry-content4">
															...
															<?php 
															    ...
															    // Extraemos todas las imágenes
															    preg_match_all( strtolower($extrae)  , $Html_ch , $matches );
																...
																$post_content=explode("<em><!--more--></em>",$Html_ch);
																...
																preg_match_all( $extrae , $post_content , $matches3 );
																$image3 = $matches3[1][0];
																
																if($image_ch!="") {
																	$image_ch=str_replace("'", '"', $image_ch);
																	$image_ch=str_replace("SRC", 'src', $image_ch);
																	$image3=$image_ch;
																}
																

																$image3=explode('src="',$image3);
																$image3=$image3[1];
															    ...
															    {?>
																	<div class="imagen_post">
																	<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><img <?php echo $image3;?> alt="<?php the_title(); ?>" width="293" title="<?php the_title(); ?>" /></a>
																	</div>
																<?}else{?>
