...
?>
<!DOCTYPE html>
<html lang="es-AR" xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
<head>
<meta charset="UTF-8">
				...
				<div class="menu-header">
					<ul id="menu-principal" class="menu">
						...
						<li data-category="alfombraroja" class="menu-item menu-item-type-post_type menu-item" style="padding-bottom:30px;">
							<h5><a class="menu-item-a" data-seccion="alfombraroja" href="<?php echo home_url( '/' ); ?>category/alfombraroja" OnMouseOver="this.style.borderColor='<?php echo cat_color('alfombraroja');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('alfombraroja');?>; <?if(is_category('alfombraroja')) echo ("border-color:".cat_color('alfombraroja').";");?>">RED CARPET</a></h5>
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="eshows" href="#" OnMouseOver="this.style.borderColor='#fff';"  OnMouseOut="this.style.borderColor='#000';" style="color:#fff; <?if(is_category('efashionblogger')) echo ("border-color:'#fff';");?>">E! Blogs</a></h5>
						...
						<!--<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="copadelmundo" href="<?php echo home_url( '/' ); ?>category/copadelmundo" OnMouseOver="this.style.borderColor='<?php echo cat_color('copadelmundo');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('copadelmundo');?>; <?if(is_category('copadelmundo')) echo ("border-color:".cat_color('copadelmundo').";");?>">COPA</a></h5>
						</li> -->
						<!--<li class="menu-item menu-item-type-post_type menu-item">
						...
						<!--<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="copadelmundo" href="<?php echo home_url( '/' ); ?>category/copadelmundo" OnMouseOver="this.style.borderColor='<?php echo cat_color('enews');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('enews');?>; <?if(is_category('enews')) echo ("border-color:".cat_color('enews').";");?>">Copa</a></h5>
						</li>-->
