...
function traer_data(info, jsonData){
  ...
  for (var i=0; i<cantidad; i++) {
    ...
    if(title.videoStillURL != null){
      ...
      str+='<a href="javascript:void(0);" onclick="'+ VAR_DTM + VAR_Data + VAR_gaq +'"><div itemscope itemtype="http://schema.org/VideoObject" class="videos" videoId="'+title.id+'"><link itemprop="url" href="http://la.eonline.com/<?=$name_feed?>/pagina/videos-2/?id='+title.id+'"/><link itemprop="thumbnailUrl" href="'+title.videoStillURL+'"><meta itemprop="videoId" content="'+title.id+'"><div class="feed-image-container"><img src="'+title.videoStillURL+'" alt="testing"><div class="feed-duration"></div></div><div class="feed-caption"><h3 itemprop="name">'+title.name + '</h3></div></div></a>';      resp.innerHTML+=str;
    }
...
function traer_data_2(info, jsonData2){
  ...
  for (var i=0; i<cantidad; i++) {
    ...
    if(title.videoStillURL != null){
      ...
      str_RC+= '<li><a href="javascript:void(0);" onclick="'+ VAR_DTM + VAR_Data + VAR_gaq +'"><div itemscope itemtype="http://schema.org/VideoObject" class="videos" videoId="'+title.id+'"><link itemprop="url" href="http://la.eonline.com/<?=$name_feed?>/pagina/videos-2/?id='+title.id+'"/><link itemprop="thumbnailUrl" href="'+title.videoStillURL+'"><meta itemprop="duration" content="'+duration+'"><meta itemprop="videoId" content="'+title.id+'"><div class="feed-image-container"><img rel="fancybox" src="'+title.videoStillURL+'" alt="testing"><div class="feed-duration">'+duration+'</div></div><div class="feed-caption"><h3 itemprop="name">'+title.name +'</h3></div></div></a></li>';
          ...
          <h2 style="color:<?php echo cat_color('videos-2');?>; margin-bottom:20px;">VIDEOS</h2>
                 ...
                 <div id="carrousel_MV" class="tira_chica">
                   ...
                   <div id="playerPrincipal" style="width:570px;float:left;margin-bottom:10px;">
                        ...
                        <?if($_GET["abz"]!=""){?>
                          <video id="really-cool-video" style='width: 570px;height: 370px;'
                            data-video-id="4531923353001"
                            data-account="96980687001"
                            data-player="553b59c3-4773-4446-8ce1-9a4199b98a2f"
                            data-embed="default"
                            data-setup="{}"
                            class="video-js" controls></video>
                          <script src="//players.brightcove.net/96980687001/553b59c3-4773-4446-8ce1-9a4199b98a2f_default/index.min.js"></script>
