<div id="clients">
	...
	$galerias = $mydb2->get_results("SELECT ar_1, ar_2, ar_3, ar_4, ar_5 FROM abmGalDestacadas", ARRAY_A);

	
	
				for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["ar_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>pagina/fotos-argentina" rel="bookmark" style="color:#ff0099; font-size:18px;">Ver más galerias</a>
						</div>
