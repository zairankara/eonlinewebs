					...
					<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
									...
									<div id="post-<?php the_ID(); ?>" class="hentry_gr">
										...
										<!-- ADRENALINE TAG START-->
													<script>
										            var aDlneOpt = {
										                adUnit: 'https://pubads.g.doubleclick.net/gampad/ads?sz=300x250|640x480&iu=/8877/Argentina/Adrenaline&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&description_url=[description_url]&correlator=[timestamp]&vpos=preroll&cust_params=postid%3D<?php echo(get_the_ID())?>'
										            },aDlneProt;
