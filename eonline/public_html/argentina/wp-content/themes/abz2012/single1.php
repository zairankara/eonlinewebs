				...
				<div class="cont_blanco">
					...
					<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
									<div id="post-<?php the_ID(); ?>" class="hentry_gr">
										...
										if ($texto) {?>
											<div style="width:600px;height:30px; border-top:1px solid #ddd;"><div style="float:left;width:310px; height:30px; display:block;"><?=$texto?></div><span style="color:#fff;">0707</span></div>
								 		<?}?>
								 		<!-- / BANNER ADPOST-->
