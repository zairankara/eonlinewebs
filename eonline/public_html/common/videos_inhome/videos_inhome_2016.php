						...
						function getTopVideos_HM() {
							addScriptTag("topVideos_HM", "http://api.brightcove.com/services/library?command=search_videos&any=tag%3Adestacado&page_size=10&media_delivery=http&sort_by=MODIFIED_DATE%3ADESC&token=<?php echo $token;?>", "response_HM");
						}
                            ...
                            for (var i=0; i<cantidad; i++) {
                                ...
                                if(i==0){
                                    ...
                                    if(title.videoStillURL != null){
                                        str_RC+= '<article data-idvideo="'+title.id+'" data-idtitle="'+titleSTR+'"  data-src="'+title.videoStillURL+'" data-duration="'+duration+'" data-name="'+title.name + '"></article>';
                                        ...
                                        str_RC2='<article data-idvideo="'+title.id+'" data-idtitle="'+titleSTR+'" ><a href="/<?php echo strtolower($name_feed)?>/pagina/videos-2/?id='+title.id+'" ><div class="videos" videoId="'+title.id+'"><div class="feed-image-container"><div class="play"></div><img rel="fancybox" src="'+title.videoStillURL+'" class="img-responsive" alt="testing"></div><div class="feed-caption"><h4>'+title.name + '</h4></div></div></a></article>';
