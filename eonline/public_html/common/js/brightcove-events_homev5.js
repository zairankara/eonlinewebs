videojs.plugin('customEventPlugin', function() {
  ...
  var myPlayer = this,
            ...
            myPlayer.on("pause", function () {
                console.log('This VIDEO pause v5 ');
                document.getElementById("featuredvideo__herotext").style.display = 'block';
            });

            myPlayer.on("play", function () {
                console.log('This VIDEO play v5');
                document.getElementById("featuredvideo__herotext").style.display = 'none';
            });
