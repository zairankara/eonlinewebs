<div id="clients" class="galerias_dest_theroyals">
	...
	$galerias = $mydb2->get_results("SELECT the_royals_1, the_royals_2, the_royals_3, the_royals_4, the_royals_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["the_royals_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>pagina/fotos-<?=$name_feed?>" rel="bookmark" style="color:<?php echo cat_color($name_cat);?> !important; font-size:18px;">Ver más galerias</a>
						</div>
