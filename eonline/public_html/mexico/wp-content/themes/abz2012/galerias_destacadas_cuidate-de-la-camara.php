<div id="clients" class="galerias_dest_cuidate">
	...
	$galerias = $mydb2->get_results("SELECT cuidate_mx_1, cuidate_mx_2, cuidate_mx_3, cuidate_mx_4, cuidate_mx_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["cuidate_mx_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>pagina/fotos-mexico" rel="bookmark" style="color:<?php echo cat_color($name_cat);?> !important; font-size:18px;">Ver más galerias</a>
						</div>
