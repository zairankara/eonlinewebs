	...
	<div id="content" role="main">
		<div class="cont_one-clumn" id="paginafotos">
			...
			<br clear="all"/>
					...
					$valor_season = $mydb2->get_results('SELECT mundial_mx FROM abmGalDestacadas', ARRAY_A);
					$mundial_mx=$valor_season[0]["mundial_mx"];
					...
					foreach($galleries as $image){
								...
								if($id_galeria!=$mundial_mx && $id_galeria!=12845  && $id_galeria!=10076 && $id_galeria!=13070 && $id_galeria!=7538 && $id_galeria!=13242 && $id_galeria!=18490){
