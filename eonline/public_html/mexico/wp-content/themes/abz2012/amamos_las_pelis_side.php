...
$col="white";
	...
	$sql="SELECT * FROM  abmAmamosHorarios where activate = 1 and feed = 3";
...
<tr style="background-color:<?=$col?> !important">
 <td style="padding-bottom:5px !important; color:#848484; text-transform: capitalize !important;"><?echo(utf8_decode($descripcion));?></td>
</tr>
