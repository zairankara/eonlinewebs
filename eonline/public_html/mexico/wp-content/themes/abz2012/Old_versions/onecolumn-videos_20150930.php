...
function getTopVideos_CE() {
  addScriptTag("topVideos_CE", "http://api.brightcove.com/services/library?command=find_playlist_by_id&playlist_id=<?=$playlist_CE?>&media_delivery=http&token=<?=$token?>", "response_CE");
}
