...
EOT;
						...
						<div style="margin-right:10px; margin-top: 10px; float:right;">
							<a href="http://twitter.com/share" class="twitter-share-button" data-text="Sitio recomendado" da ta-count="horizontal" data-via="EonlineLatino" data-lang="es">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
						</div>
...
<script src="/varios/adblocker/adblockDetectorGA.js"></script>
<script>
