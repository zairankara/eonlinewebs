...
?>
        ...
        <!--.MODAL ONLINE POLL-->
                <!--<style type="text/css">
                    ...
                    .modal-body iframe{
                        margin: 0 auto;
                        border:0; max-width: 500px;  width: 100%; height: 500px;
                    }
                ...
                <div class="modal fade" id="myModal" style="display: none;">
                  ...
                  <div class="modal-body">
                        ...
                        <iframe src="http://la.eonline.com/experience/2017/encuestaOnline/index.php?f=3" ></iframe>
                  </div>
                </div>-->
        <!--.MODAL ONLINE POLL-->
        ...
        <!--personalizacion Encuesta online-->
            ...
            jQuery(window).on('load',function(){
                ...
                if (document.cookie.indexOf('voted_poll_new_etapa2') == -1) {
                   ...
                   ga('send', 'event', 'Encuesta Online', 'Mexico', 'Abrir');
                }else{
            ...
            jQuery(".modal-backdrop").click(function(e){
                ...
                ga('send', 'event', 'Encuesta Online', 'Mexico', 'Cierre');
                //console.log("Close");
            })
		...
		<!--personalizacion-->
            ...
            <?}elseif(is_single()){?>
               ...
               <script async src="/common/feeds/single_mx.min.js"></script>
...
<script src="/varios/adblocker/adblockDetectorGA2016.js"></script>
<script>
...
<?php if( is_single() ){ ?>
    ...
    _ttf.push({
           pid          : 54963
           ,lang        : "es"
           ,slot        : '.site-main .entry-content > p'
           ,format      : "inread"
...
<!-- Pedido de Villarreal, Maria Paola y Torres, Luisa 5-8-2017-->
