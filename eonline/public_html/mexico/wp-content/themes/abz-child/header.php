...
if($_POST["flag"]==1){
	...
	switch($cual){
		...
		case "2":header('Location:/mexico/');break;
...
<?}?>-->
        ...
        <?php } elseif(is_category()||is_tag()||is_page()) { ?>
            ...
            if(is_page("eshows")){
                ...
                $description_site="Si deseas contemplar muy de cerca el lifestyle de las celebridades y la socialité mexico, Soledad Aniesa te lleva a conocerlo.";
        ...
        <?php } else { ?>
            ...
            <?
            $title_site="E! Online Latino | Mexico";
            $description_site="E! Latinoamérica. Todo el mundo del espectáculo y la cultura Pop en vivo desde Hollywood. ".$title_site;
            ?>
            <title><?php echo $title_site ?></title>
            <meta name="description" content="<?php echo $description_site ?>" />
        ...
        <script type='text/javascript'>
         googletag.cmd.push(function() {
                if(isMobile()){
                    <?php include(STYLESHEETPATH."/pages/defineslots_mexico_dynamic_mobile.php"); ?>
                }else{
                    <?php include(STYLESHEETPATH."/pages/defineslots_mexico_dynamic.php"); ?>
                }

                //googletag.pubads().enableSyncRendering();
                googletag.defineSlot('/8877/De_Terceros/JustPremium', [1, 1], 'JustPremium').addService(googletag.pubads());
        ...
        <!--<script type='text/javascript'>
            ...
            googletag.companionAds().setRefreshUnfilledSlots(true); //video roadblock
            googletag.pubads().enableVideoAds(); //video roadblock
            googletag.pubads().enableSyncRendering();
            googletag.pubads().enableSingleRequest();
            googletag.pubads().collapseEmptyDivs();
            googletag.enableServices();
        ...
        <?php if(is_home() || is_category()){?>
            ...
            _ttf.push({
                   pid          : 54964
                   ,lang        : "es"
                   ,slot        : '#main .page-header #libre, #main .site-title'
                   ,format      : "inboard"
                   ,minSlot     : 1
                   ,components  : { mute: {delay :3}, skip: {delay :3} }
                   ,css         : "padding: 0px 0px 120px;"
                   ,before      : true
            });
    ...
    <body id="mexico" <?php body_class(); ?> <?php if($title_post) echo ('data-title="'. utf8_decode($title_post).'"');?>  <?php echo "data-slug='".que_section_es()."'";?>>
                        ...
                        <div id="NavR_Header_MainContent" class="NavR_Header_MainContent">
                            <div class="hidden-xs visible-sm visible-md visible-lg">
                                ...
                                <div id="NavR_Header_Search_Action" class="NavR_Header_Search_Action" itemscope itemtype="http://schema.org/WebSite">
                                    <meta itemprop="url" content="http://la.eonline.com/mexico"/>
		...
		<div class="container page-container">
            ...
            <!-- /8877/De_Terceros/JustPremium -->
            <div id='JustPremium' style='height:1px; width:1px;'>
                <script>
                googletag.cmd.push(function() { googletag.display('JustPremium'); });
                </script>
            </div>
            <!-- /Banner Justpremium -->
