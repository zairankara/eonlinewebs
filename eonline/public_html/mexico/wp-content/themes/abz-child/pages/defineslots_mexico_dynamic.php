	...
	if(is_home() || is_search()  || is_tag()){
				...
				endwhile;*/
					$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-home-300x250-1').addService(googletag.companionAds()).addService(googletag.pubads());
                    ...
                    googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Home/BoxBanner_1', [300, 250], 'div-gpt-ad-home-300x250-3').addService(googletag.pubads());
                    googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Home/BoxBanner_1', [300, 250], 'div-gpt-ad-home-300x250-4').addService(googletag.pubads());
                    googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Home/BoxBanner_1', [300, 250], 'div-gpt-ad-home-300x250-5').addService(googletag.pubads());
					googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-home-728x90').addService(googletag.companionAds()).addService(googletag.pubads());
				...
				if(is_single()){
					...
					$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Nota/BoxBanner_1', [300, 250], 'div-gpt-ad-Post-300x250-1').addService(googletag.companionAds()).addService(googletag.pubads());
					googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Nota/BoxBanner_2', [300, 250], 'div-gpt-ad-Post-300x250-2').addService(googletag.pubads());
					googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Nota/LeaderBoard', [728, 90], 'div-gpt-ad-Post-728x90').addService(googletag.companionAds()).addService(googletag.pubads());
				...
				switch($postSlug){
					...
					break;
					case "galaxyguru":
						$name_sectionDFP="galaxyguru";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/LeaderBoard', [728, 90], 'div-gpt-ad-galaxyguru-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Enews/Floating_3ros', 'div-gpt-ad-galaxyguru-floating_3ros').addService(googletag.pubads());";
					break;
					case "eshows":
						$name_sectionDFP="Eshows";
					...
					break;
					case "cambiame-el-look":
						$name_sectionDFP="cambiame-el-look";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/BoxBanner_1', [300, 250], 'div-gpt-ad-cambiame-el-look-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/LeaderBoard', [728, 90], 'div-gpt-ad-cambiame-el-look-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Enews/Floating_3ros', 'div-gpt-ad-cambiame-el-look-floating_3ros').addService(googletag.pubads());";
					break;
					case "wild-on":
						$name_sectionDFP="wild-on";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/BoxBanner_1', [300, 250], 'div-gpt-ad-wild-on-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/LeaderBoard', [728, 90], 'div-gpt-ad-wild-on-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Enews/Floating_3ros', 'div-gpt-ad-wild-on-floating_3ros').addService(googletag.pubads());";
					break;
					case "efitness":
						$name_sectionDFP="efitness";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/BoxBanner_1', [300, 250], 'div-gpt-ad-efitness-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Enews/LeaderBoard', [728, 90], 'div-gpt-ad-efitness-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Enews/Floating_3ros', 'div-gpt-ad-efitness-floating_3ros').addService(googletag.pubads());";
					break;
					case "live-from-e":
                        $name_sectionDFP="live-from-e";
                        $cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/BoxBanner_1', [300, 250], 'div-gpt-ad-".$name_sectionDFP."-300x250-1').addService(googletag.pubads());
                                    googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-".$name_sectionDFP."-728x90').addService(googletag.pubads());
                                    googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Floating_3ros', 'div-gpt-ad-".$name_sectionDFP."-floating_3ros').addService(googletag.pubads());";
                    break;
					case "fotos-mexico":
					...
					case "galerias":
						...
						$cod_slots="googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Floating_3ros', 'div-gpt-ad-galerias-floating_3ros').addService(googletag.pubads());";
					break;
					case "videos-2":
						$name_sectionDFP="Videos";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Videos/LeaderBoard', [728, 90], 'div-gpt-ad-videos-2-728x90').addService(googletag.pubads());
					...
					case "yosoyelartista":
						$name_sectionDFP="Homepage";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-yosoyelartista-728x90').addService(googletag.pubads());";
					break;
					default:
						$name_sectionDFP="Homepage";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-home-728x90').addService(googletag.pubads());";
