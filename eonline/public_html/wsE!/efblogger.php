...
?>
<html>
<title>WS Consume Manual EFashion Blogger</title>
<head>
...
body {
   background: url(efblogger/bg.jpg) top center no-repeat;
}
div{
	font-family:arial;
	font-size:12px;
...
<div class="reporte" id="reportes" <?if($_SESSION["informes_migrados"]!="" || $_SESSION["report"]!="" || $_SESSION["informes_errors"]!=""){?> style="display:block"<?}?>>
    ...
    <input type="hidden" name="consumir" value="post">
    <div class="content">
