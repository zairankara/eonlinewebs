...
if(preg_match('/iPhone|Android|Blackberry/', $agent)){  
	header('Location:http://br.eonline.com/mobile/parser.php');
    exit;  
}  
/**
...
<link rel="shortcut icon" href="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/images/favicon.ico"/>
...
$default_img = "http://br.eonline.com/wp-content/themes/E-online/images/e_facebook_BR.jpg";
...
/*jQuery(document).ready(function() {
	$.fancybox(
		'<div><IMG SRC="http://br.eonline.com/wp-content/themes/E-online/images/comunes/kourtneyTNY.gif" whidth="480" height="52" BORDER="0" ALT=""></div><div style="margin-top:5px;"><div style="display:none"></div><object id="myExperience1545219087001" class="BrightcoveExperience"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="480" /><param name="height" value="270" /><param name="playerID" value="773795205001" /><param name="playerKey" value="AQ~~,AAAAFpR_2Jk~,FZYC7qwaTWPZRpAgEIVYABg4ulQxTkb-" /><param name="isVid" value="true" /><param name="isUI" value="true" /><param name="dynamicStreaming" value="true" /><param name="@videoPlayer" value="1545219087001" /></object></div>',{
...
<!-- OPENX -->
<script type='text/javascript' src='http://adsrv01.eonlinelatinola.com/www/delivery/spcjs.php?id=2'></script>
<!-- / OPENX --> 

<!-- STYLES -->
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'stylesheet_url' ); ?>" />
<?php
		if (( in_category( "tapetevermelho" ) ||  in_category( "goldenglobe" ) ||  in_category( "sag" ) ||  in_category( "grammy" ) ||  in_category( "oscar" ) ||  in_category( "emmy" )  ||  in_category( "teenchoice" )  ||  in_category( "baftaawards" )  ||  in_category( "latinbillboard" )) && ! is_home() )
		{
		$cat_alf=1;
		}
		if ( is_category( "tapetevermelho" ) ||  is_category( "goldenglobe" ) ||  is_category( "sag" ) ||  is_category( "grammy" ) ||  is_category( "oscar" ) ||  is_category( "emmy" )  ||  is_category( "teenchoice" )  ||  is_category( "baftaawards" )   ||  is_category( "latinbillboard" ) ||  $cat_alf==1)
		{
		?>
		...
		<?}
		if( is_tag( "olimpiadas") || is_tag( "londres")  || is_tag( "jogos olimpicos")&& ! is_home() ){?>
...
jQuery(document).ready(function() {
	$.fancybox(
		'<a href="http://www.eonlineexperiences.com/harrypotter/BR/"><img src="http://la.eonline.com/harrypotter/bannerBR.jpg"></a>',
		{
        	'autoDimensions'	: false,
			'width'         : 715,
			'height'        : 356,
...
<script type='text/javascript'><!--//<![CDATA[
   var ox_u = 'http://adsrv01.eonlinelatinola.com/www/delivery/al.php?zoneid=108&target=_blank&cb=INSERT_RANDOM_NUMBER_HERE&layerstyle=simple&align=center&valign=middle&padding=0&closetime=20&padding=0&shifth=0&shiftv=0&closebutton=t&nobg=t&noborder=t';
...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
		...
		<div id="cont_search_banners">
			<div id="buscador_top">
			<ul id="menu_top">
				<li><a href="http://br.eonline.com/index.php">Início</a> | </li>
				<li><a href="http://br.eonline.com/contacto/">Contato</a> | </li>
				<li><a href="http://br.eonline.com/feed/"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/images/comunes/ico_RSS.gif" alt="" width="23" height="17" border="0">Conteúdos RSS</a> | </li>
				<li><a href="http://www.facebook.com/pages/E-Online-Brasil/145725988795846?ref=sgm">Curta no <img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/images/comunes/ico_facebook.gif" alt="" width="22" height="22" border="0"></a> | </li>
				<li><a href="http://twitter.com/Eonlinebrasil" target="_blank">Siga no <img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/images/comunes/ico_twitter.gif" alt="" width="22" height="22" border="0"></a></li>
			</ul>
			<?php get_search_form(); ?>
			<br clear="all" />
			</div>
						...
						<?php if ( is_active_sidebar( 'third-footer-widget-area' ) ) : ?>
										<div id="third" class="widget-area">
											<ul class="xoxo">
												...
												<script type='text/javascript'><!--// <![CDATA[
												    OA_show(7);
												// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=9084279'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=7&amp;n=9084279' /></a></noscript>
											</ul>
					 ...
					 if ( is_active_sidebar( 'fourth-footer-widget-area' ) ) : ?>
									<div id="fourth" class="widget-area">
										<ul class="xoxo">
											...
											<script type='text/javascript'><!--// <![CDATA[
											    OA_show(8);
											// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=b28e438'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=8&amp;n=b28e438' /></a></noscript>
										</ul>
		...
		<div id="masthead">
			...
			<div id="branding" role="banner">
				...
				<div id="destacados_H">
					...
					$sqlstr="SELECT *
					FROM abmBanners
					WHERE id_feed=99 AND activo=1 AND newdesign=0 AND ( dia=CURDATE() OR ".$dia_semana."=1) ORDER by fecha DESC";
