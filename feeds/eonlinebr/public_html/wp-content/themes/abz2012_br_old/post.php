<?php if ( in_category( _x('gallery', 'gallery category slug', 'twentyten') ) ) : ?>
									<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
														...
														<div class="entry-utility">
															...
															<div class="post-comments"><?php comments_popup_link( __( 'Comentar', 'twentyten' ), __( '1 Comentário', 'twentyten' ), __( '% Comentarios', 'twentyten' ) ); ?></div>
														</div><!-- .entry-utility -->
					...
					<?php else : ?>
						...
						<?php if(is_category("the-kardashians")){?>
								<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
											...
											if ($texto) {?>
												<div style="border:1px solid #ddd;width:310px; height:30px; display:block;"><?=$texto?></div>
									 		<?}?>
									 		<!-- / BANNER ADPOST-->
												...
												<div class="entry-content_int_gr_ab">
													...
													<h2 class="entry-title">
														<?php if ( count( get_the_category() ) ) : ?>
															...
															} elseif ( in_category('carnaval-2013-2') || is_category('carnaval-2013-2')) {
																$color_txt="style_carnaval_txt";
															}else{
																$color_txt="";
															}?>
														<?php endif; ?>
												...
												<?php if ( is_archive() || is_search() || is_tag() ) : // Only display excerpts for archives and search. ?>
														...
														<div class="entry-content4">
															...
															<?php 
															    ...
															    {?>
																	<div class="imagen_post">
																	<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><img <?php echo $image_ch;?> alt="" /></a>
																	</div>
																<?}else{?>
																	<div class="imagen_post_gen">
																		<a href="#">
																			<img src="<?php bloginfo('template_url')?>/images/generica.jpg" alt="" />
																		</a>
																	</div>
				                       							<?}?>
													    ...
													    if($tiene_video_home==0){
														    ...
														    {?>
																...
																<?
														       	...
														       	echo("<div class='caption_img ".$bg_fondo."'>".$extracto_caption."</div>");
														       	?>
			                       							<?}?>
			                       						<?}?>
