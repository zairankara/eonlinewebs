...
<div class="popular-posts " style="margin-top:8px;"><a href="<?php echo home_url( '/' ); ?>category/the-kardashians"><img src="<?php bloginfo('template_url')?>/kardashians/titulo_todaypic.jpg" alt="Cabezal the kardashians"/></a></div>


	<ul class="sidebar_300" style="display:block;margin-bottom:8px;">
		<?
		$query= "tag=fotodia_kardashians&amp;orderby=date&amp;order=ASC"; //ordenacion ascendente por fecha
