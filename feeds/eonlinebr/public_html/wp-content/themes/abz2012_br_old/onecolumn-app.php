			...
			<div id="content" role="main">
					...
					<div class="fondo_app">
						...
						Navegue por centenas de galerias de fotos das celebridades mais importantes e não perca os vídeos de seus programas favoritos, como Keeping Up With Kardashians, E! VIP e Brasil Bites. Fique por dentro dos tópicos mais quentes do dia e saiba quais estrelas e astros são o assunto do momento. Compartilhe notícias, fotos e vídeos com seus amigos no Facebook e Twitter!O novo aplicativo do E! Online tem o melhor do mundo do entretenimento... a cultura pop nunca esteve tão perto de você. Be on E!
							<div class="iconos">
									<a href="https://itunes.apple.com/br/app/e!-online/id576087540?ls=1&mt=8" class="apple" onmouseover="tooltip.show('<img src=\'<?php bloginfo('template_directory'); ?>/images/app/IOS_brasil.png\'/>');" onmouseout="tooltip.hide();" onClick="_gaq.push(['b._trackEvent', 'Descargas APP', 'Iphone']);"></a>
								<a href="https://play.google.com/store/apps/details?id=com.eonline.la.Ebr" class="android" onmouseover="tooltip.show('<img src=\'<?php bloginfo('template_directory'); ?>/images/app/google_play_brasil.png\'/>');" onmouseout="tooltip.hide();" onClick="_gaq.push(['b._trackEvent', 'Descargas APP', 'Android']);"></a>
