<div id="clients" style="background-color:#000000;">
	<div class="entry-utility" style="float:left;">
		<h3 style="color:#000; background-color:#24eca3; margin: 8px; display:block;">ÚLTIMAS GALERIAS</h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT ca_br_1, ca_br_2, ca_br_3, ca_br_4, ca_br_5 FROM abmGalDestacadas", ARRAY_A);
				...
				for($al=1;$al<=5;$al++){
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>galerias" rel="bookmark" style="color:#24eca3; font-size:18px;">Ver mais galerias</a>
						</div>
