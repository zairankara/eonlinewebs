...
<?php
if(is_home()){?>
	<h3><a href="<?php echo home_url( '/' ); ?>category/thetrend"><img src="<?php echo esc_url( get_template_directory_uri() )?>/images/cabezal_thetrend.jpg" alt="Cabezal The Trend"/></a></h3>
