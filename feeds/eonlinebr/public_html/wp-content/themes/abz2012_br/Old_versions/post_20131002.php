											...
											<div class="entry-content2">
												...
												<div class="entry-utility">
													<?php if ( count( get_the_category() ) ) : 
														...
														?>
														<h3 style="background-color: <?php echo cat_color($name_cat);?> !important;"><a href="<?php echo home_url( '/' ); ?>category/<?=$name_cat?>" title="THE KARDASHIANS" rel="category tag">KARDASHIANS</a></h3>
													<?php endif; ?>
												</div>
												<!-- / CATEGORIA / SECCION -->
