<div id="clients" class="galerias_dest_redcarpet">
	...
	$galerias = $mydb2->get_results("SELECT rc_br_1, rc_br_2, rc_br_3, rc_br_4, rc_br_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["rc_br_".$al];
