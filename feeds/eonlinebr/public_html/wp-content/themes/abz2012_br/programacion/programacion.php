...
<div class="col_izq">
	...
	<ul class="menu_horario">
		<li><a href="#" onclick="variables(1, <?=$_POST["dia"]?>);" title="MANHÃ" class="manana <?if ($_POST["franja"]=="1") echo ("selected");?>">MANHÃ</a></li>
		<li><a href="#" onclick="variables(2, <?=$_POST["dia"]?>);" title="TARDE" class="tarde <?if ($_POST["franja"]=="2") echo ("selected");?>">TARDE</a></li>
		<li><a href="#" onclick="variables(3, <?=$_POST["dia"]?>);" title="NOITE" class="noche <?if ($_POST["franja"]=="3") echo ("selected");?>">NOITE</a></li>
		<li><a href="#" onclick="variables(4, <?=$_POST["dia"]?>);" title="TARDE DA NOITE" class="trasnoche <?if ($_POST["franja"]=="4") echo ("selected");?>">TARDE DA NOITE</a></li>
	</ul>
	<!-- / Menu Horario -->
...
<input type="hidden" name="franja" id="franja">
	...
	if($cant==0 || !isset($cant)){
			echo ("Nossa page no está em manutenção. Por favor, tente novamente mais Tarde.");
	}else{
				...
				if($i%2==0){
					...
					<div class="modulo_prog">
						<div class="<?=$franja?>">
							...
							<div class="programa_img"> <img src="<?=$imagen; ?>" alt="<?echo $titulo?>" title="<?echo $titulo?>" width="233" height="65" border="0" align="left" /></div>
							<div class="programa">
							<h3><?echo $titulo?></h3>
							<p><?if($content_la) echo utf8_decode($content_la);?></p>
							<h2 style="text-indent:9000px"><?if($content_la) echo utf8_decode($content_la);?></h2>
							</div>
							<br clear="all" />
						</div>
					</div>
