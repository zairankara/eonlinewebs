                      ...
                      <? //if($_GET["abz"]!="")  echo $post->ID."-".$i;?>
                          ...
                          if(is_home()){
                              ...
                              <?}
                                ...
                                $cat_name=$cat->name;
                                $color_txt="";
                                if(is_category("noivas")) $color_txt="color: #fff !important;";
                                if(is_category("the-royals")) $color_txt="color: #fff !important;";

                                ?>
                                <h3 style="background-color: <?php echo cat_color($name_cat);?> !important; <?php echo $color_txt;?>">
                                  <?php echo $cat_name; ?>
                                </h3>
                                <?
                            }?>
                          ...
                          $image_ch_explode_resize=url_resize_2014($Html,$anchofoto);
														
											    if($tiene_video_home==""){
    												    if($image_ch_explode){?>
                                      <div class="imagen_post">
                                      <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><img <?php echo $image_ch_explode_resize;?> alt="<?php the_title_attribute(); ?>" title="<?php the_title_attribute(); ?>"/></a>
          														</div>
                        ...
                        <!-- / REDES SOCIALES POR POST-->
                                  ...
                                  <span class="vcard author" style="display:none;">
                                   <span class="fn"><a href="https://plus.google.com/+Eonlinebrasilplus?rel=author" rel="author">Eonline Brasil</a></span>
                                 </span>
												</div><!-- .entry-meta -->
...
<?php if( is_search() || is_tag() || $archive==1){?>
  <?php if( $archive==1 && $c==0) echo "";?>
  <?php if( is_search() && $c==0) echo "";?>
  <?php if( is_tag() && $c==0) echo "";?>
                        ...
                        <div class="entry-content_int_gr_arr">
                          ...
                          <?php //the_content( __( '<span class="leer_mas"></span>', 'twentyten' ) ); 
                            ...
                            $patron = '|<p class=["\']wp-caption-text["\']>(.*?)</p>|is'; 
                              ...
                              $tiene_video_home=sacar_video($Html);
                              $image_ch_explode=sacar_img_con_src($Html);
                              $image_ch_explode_resize=url_resize_2014($Html,310);
                                                                   
                              if($tiene_video_home==""){
                                if($image_ch_explode_resize)
                                {?>
                                <div class="imagen_post">
                                <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><img <?php echo $image_ch_explode_resize;?> alt="<?php the_title_attribute(); ?>" width="293" title="<?php the_title_attribute(); ?>"/></a>
                                </div>
                                <?php echo("<div class='caption_img'>".$extracto_caption."</div>"); ?>
                                 <?}?>
                              <?}else{?>
                        ...
                        <div class="entry-content_int_gr_ab">
                          ...
                          <h1 class="entry-title">
                            <?php if ( count( get_the_category() ) ) : ?>
                              ...
                              } elseif ( in_category('tapetevermelho') || is_category('tapetevermelho')) {
                                $color_txt="style_redcarpet_txt";
                              } elseif ( in_category('videos') || is_category('videos')) {
                      ...
                      <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <div class="entry-content4">
                              ...
                              <?php 
                                ...
                                $Html = get_the_content();
                                $image_ch_explode=sacar_img_con_src($Html);
                                $image_ch_explode_resize=url_resize_2014($Html,140);

                                
                                if($image_ch_explode)
                                  {?>
                                  <div class="imagen_post">
                                  <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><img <?php echo $image_ch_explode_resize;?> alt="<?php the_title(); ?>" width="293" title="<?php the_title(); ?>" /></a>
                                  </div>
                                <?}else{?>
                                  <div class="imagen_post_gen">
                                    <a href="#">
                                      <img src="<?php echo esc_url( get_template_directory_uri() )?>/images/generica.jpg" alt="Imagen E!" title="Imagen E!" />
                                    </a>
                                  </div>
                                 <?}?>
