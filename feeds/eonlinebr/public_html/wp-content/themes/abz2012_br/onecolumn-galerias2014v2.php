...
<script src="http://connect.facebook.net/pt_BR/all.js#xfbml=1&status=0"></script>
...
<script>var fruits = [];var alttext = [];var tit_text = []; var height_img = []; var width_img = [];var alttext_limpio = [];</script>
<?
$miarray_tit = array();
$miarray_url = array();
$miarray_desc = array();
...
<div class="galeri_inferior" style="z-index:1000;">
	...
	<ul id="carouselThumb" class="gallerythumb">
	    ...
	    foreach($galleries2 as $image_ch){
							...
							$height_url = ObtenerHeight($urlImg);
							$width_url = ObtenerWidth($urlImg);
							...
							height_img.push("<?=$height_url?>");
							width_img.push("<?=$width_url?>");
							...
							?>
							 <li><img src="<?=$image_ch_thumb_explode_resize;?>" height="80" alt="<?=$titulo?>" title="<?=$titulo?>" data-descripcion="<?=$description?>"/></li>
		<?
		 $cont_img++;
		 }?>
	   </ul>
								    ...
								    <div class="placa_galeria">
										...
										<div class="titulo_galeria">
											...
											<div class="share" id="share"> 
												<?
												$url_share2 = "http://la.eonline.com/varios/share_facebookbr.php";
												$url_share3 = "http://la.eonline.com/varios/share_facebookbr.php%26rnd=".rand(0,5000)."%26gal=".$gallery."%26img=".$miarray_url[0]."%26nogeo=1%26t=".$miarray_tit[0]."%26d=".$miarray_desc_limpio[0];
												...
												<a target='_blank' href='http://twitter.com/home?status=<?php echo urlencode($miarray_tit[0]." ".$miarray_url[0]);?>' data-url='<?=$miarray_url[0]?>' data-text='<?=$miarray_tit[0]?>' class='twitter-share' data-via='eonlinelatino' data-lang='es' data-dnt='true'><span></span></a>
...
<script type="text/javascript">
	...
	$("#imgRightBig").click(function() {
			...
			//console.log("width"+width_prox);
			//console.log("height"+height_prox);
