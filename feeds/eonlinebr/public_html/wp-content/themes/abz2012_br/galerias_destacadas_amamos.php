<div id="clients">
	<div class="entry-utility">
		<h3 style="background-color: <?php echo cat_color($name_cat);?> !important;">NOVAS FOTOS </h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT amamos_br_1, amamos_br_2, amamos_br_3, amamos_br_4, amamos_br_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["amamos_br_".$al];
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>galerias" rel="bookmark" style="color:<?php echo cat_color($name_cat);?> !important; font-size:18px;">Ver mais</a>
						</div>
