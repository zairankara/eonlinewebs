...
<div class="todoGalerias">
    <?php
    if($gallery==22312){
        echo("<a href='https://ad.doubleclick.net/ddm/clk/405429384;205556915;m' target='_blank' class='logo_carolina'><img src='http://br.eonline.com/varios/anunciantes/carolina_herrera/logo_carolina-herrera.png' width='158' height='100'></a>");
    }elseif ($gallery==15031 || $gallery==23632 || $gallery==23633) {
    	echo("<a href='' target='_blank' class='logo_patrocinio'><img src='http://br.eonline.com/varios/anunciantes/samsung/logo_samsungs8.png' width='158' height='100'></a>");
    }elseif ($gallery==23984 || $gallery==23985 || $gallery==23986  || $gallery==24405 || $gallery==24406 || $gallery==24407) {
        echo("<a href='' target='_blank' class='logo_patrocinio'><img src='http://br.eonline.com/varios/anunciantes/samsung/logo_samsungs9.png' width='158' height='100'></a>");
     }elseif ($gallery==23975 || $gallery==23994 || $gallery==23993) {
        echo("<a href='' target='_blank' class='logo_patrocinio'><img src='http://br.eonline.com/varios/anunciantes/samsung/logo_buscofem.png' width='158' height='100'></a>");
    }
    ?>
...
<script type="text/javascript">
    ...
    function changePageName(is_load, titGal, titFoto){
        if(is_load==0) {
            ...
            ga('send', 'pageview', '/<?php echo NAMEFEED; ?>/galerias_page/'+titGal+'/'+titFoto);
