    ...
    <main id="main" class="site-main" role="main">
        <div class="col-md-6 col-xs-12">
            <h3 class="site-title">ÚLTIMAS GALERIAS
                <?php if($_POST["buscar_gal"]!=""){?><span>BUSCA: <?=$_POST["buscar_gal"]?></span><?}?>
            </h3></div>
                ...
                <div class="col-sm-3 col-xs-12 grid-item-Gal">
                    <div class="entry-content">
                        <div class="imagen_post">
                            ...
                            <a href="/galerias_page/?gallery=<?php echo $id_galeria;?>" rel="bookmark" >
                            ...
                            <div class="social-icons-small" data-url="http://br.eonline.com/galerias_page/?gallery=<?php echo $id_galeria;?>?utm_campaign=VisitorShare" data-title="<?php echo $urlImg; ?>">
                                <div class="social-icon facebook">
                                    <a class="social-fb" target="_blank" onclick="share('Facebook','http://br.eonline.com/galerias_page/?gallery=<?php echo $id_galeria;?>&utm_campaign=VisitorShare', '<?php echo  $title_gal; ?>', 'Gallery', '<?php echo $urlImg; ?>');" href="javascript:void(0);"></a>
                                </div>
                                <div class="social-icon twitter">
                                    <a class="social-tw" onclick="share('Twitter','http://br.eonline.com/galerias_page/?gallery=<?php echo $id_galeria;?>&utm_campaign=VisitorShare', '<?php echo  $title_gal; ?> http://br.eonline.com/galerias_page/?gallery=<?php echo $id_galeria;?>&utm_campaign=VisitorShare', 'Gallery', '<?php echo $urlImg; ?>');" href="javascript:void(0);"></a>
                                </div>

                                <div class="social-icon whatsapp" data-mostrarMobile="1" style="display:none;">
                                    <a class="social-whatsapp" onclick="share('Whatsapp', 'whatsapp://send?text=<?php echo $title_gal; ?> http://br.eonline.com/galerias_page/?gallery=<?php echo $id_galeria;?>&utm_campaign=VisitorShare', '<?php echo  $title_gal; ?>', 'Gallery', null)" href="javascript:void(0);" ></a>
                                </div>
                            </div>
                            <!-- / REDES SOCIALES POR POST-->
                        </div>
