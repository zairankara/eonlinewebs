...
<div class="col-md-12 col-lg-12">
    <main id="main" class="site-main" role="main">
        <h3 class="site-title" style="color:#400187; margin-top:10px;">VÍDEOS</h3>
        <div class="">
            ...
            <aside class="col-md-4 col-sm-6">
                <div id="carrousel_UL" class="tira_chica">
                    ...
                    <div class="video-landing-main-content" id="videoUltimos" style="position:relative;">
                      <p id="qDiv"></p>
                      <div class="viewport">
                        <ul class="overview" id="resp_TR" ><img src="/common/videos_inhome/ellipsis.svg" style="margin:auto;"/></ul>
                      </div>
                    </div>
                </div>
            </aside>
    ...
    var BCLS = (function(window, document) {
        ...
        function traer_data_2017(info, jsonData2) {
            ...
            for (var i=0; i<cantidad; i++) {
                ...
                //console.log("-----"+elemento.custom_fields.titlebrasil);
                if(typeof elemento.custom_fields.titlebrasil !== "undefined"){
                    titleSTR=elemento.custom_fields.titlebrasil;
                }
        ...
        function response_find(jsonDataFind) {
            var titleSTR=jsonDataFind.name;
             ...
             if(jsonDataFind.custom_fields.titlebrasil != null){
              titleSTR = jsonDataFind.custom_fields.titlebrasil;
              titleSTR = titleSTR.replace(/["']/g, "");
            }
        ...
        var playlist_HM=<?php echo playlist_HM;?>,
            ...
            playlist_EN=<?php echo playlist_EN;?>,
            playlist_TR=<?php echo playlist_TR;?>,
            playlist_RC=<?php echo playlist_RC;?>,
            playlist_SW=<?php echo playlist_SW;?>;
        ...
        function init(){
            ...
            setRequestData('getPlaylistVideos', playlist_EN, null);
            setRequestData('getPlaylistVideos', playlist_TR, null);
            setRequestData('getPlaylistVideos', playlist_SW, null);
            setRequestData('moreViewsLastWeek', null, null);
        }

        var baseURL                 = 'https://cms.api.brightcove.com/v1/accounts/96980687001',
            proxyURL                = 'http://br.eonline.com/varios/videos/proxy.php',
        ...
        function setRequestData(id, playlistID, videoID) {
            ...
            switch (id) {
                ...
                case 'moreViewsLastWeek':
                    endPoint = '/videos?&sort=-plays_trailing_week&limit=10';
                    requestData.url = baseURL + endPoint;
                    requestData.requestType = 'GET';
