...
?>
				...
				<div id="footer-row" class="site-footer">
                    ...
                    <div id="footer" class="col-md-12">
                        ...
                        <div class=" col-md-2 col-md-push-8 col-xs-6">
                            <a href="http://www.enowbrasil.com" target="_blank" class="pull-right"><img src="/common/imgs/logoEnow.png" class="img-responsive"> </a>
                        </div>

                        <!-- links Pie -->
                        <div class="links_pie col-md-8 col-md-pull-2 col-xs-12 text-center">
                            <div class="ad_sales">
                                <a href="http://enowbrasil.com/" target="_blank" class="menu-item-a" >E Now Brasil</a>
                                <!--| <a href="http://www.eonlinesaladeimprensa.com/" target="_blank" class="menu-item-a" >DIGITAL SALA DE IMPRENSA</a>-->
                                | <a href="http://la.eonline.com/experience/dac/" rel="noopener" target="_blank" class="menu-item-a" >DIGITAL ADS CATALOG</a>
        ...
        <!--<style type="text/css">
                    ...
                    .modal-body iframe{
                        margin: 0 auto;
                        border:0; max-width: 500px;  width: 100%; height: 480px;
                    }
                ...
                <div class="modal fade" id="myModal" style="display: none;">
                  ...
                  <div class="modal-body">
                        ...
                        <iframe src="http://br.eonline.com/experience/2017/encuestaOnline/index.php?f=99" ></iframe>
                  </div>
                </div>-->
        <!--.MODAL ONLINE POLL-->
        ...
        <!--personalizacion Encuesta online-->
           <!--<script>
            jQuery(window).on('load',function(){
                ...
                var abz_var = getUrlParameter('abz_var'); // && abz_var == 1

                if (document.cookie.indexOf('voted_poll_new_etapa2') == -1) {
                    //console.log("Creo la cookie");
                   jQuery('#myModal').modal('show');
                   ga('send', 'event', 'Encuesta Online', 'Brasil', 'Abrir');
                }else{
            ...
            jQuery(".modal-backdrop").click(function(e){
                e.preventDefault();
                jQuery('#myModal').modal('hide');
                ga('send', 'event', 'Encuesta Online', 'Brasil', 'Cierre');
                //console.log("Close");
            })
		...
		<!--personalizacion-->
			...
			<!--/* ScrollAnimacion */-->
			<?php if( is_home() || is_category() || is_search() || is_tag() || is_archive() || is_page("altoleblon")){?>
            ...
            <?}elseif(is_single()){?>
                ...
                <script async src="/common/feeds/single_br.min.js?rnd=<?php echo rand(0,1111);?>"></script>

            <?}?>

        <?php if(is_page("galerias_page")){?>
        ...
        <script>
            (function(d, s, id) {
                ...
                js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&version=v2.6&appId=<?php echo APPID_FACEBOOK; ?>";
...
<!-- TAGS CODE INFINIA -->
<!-- <script async id="infiniasdk" data="4249d31198c67f201187a59c9a8697db" src="https://api.infiniamobile.com/apis/sdkv1/websdk/"></script>-->
<!-- / TAGS CODE INFINIA -->
...
<?php include("/home/eonlinebr/public_html/varios/remarketing/remarketing.php");?>

<!-- Crazzy Egg Code -->
<?php //include("/home/eonlinebr/public_html/varios/crazzy_egg/index.php");?>

<!-- Comscore -->
<?php include("/home/eonlinebr/public_html/varios/comscore/index.php");?>
