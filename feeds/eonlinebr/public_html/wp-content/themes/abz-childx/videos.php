...
<?php }  elseif ( is_home() ||  is_category( "zonae" ) ||  is_category( "enews" )) {?>
	...
	<div style="display: block; position: relative;"><div style="padding-top: 100%;"><video id="player" data-playlist-id="<?php echo playlist_HM; ?>"
																							...
																							data-player="B156LiFr"
																							data-embed="default"
																							class="video-js"
																							controls
																							style="width: 100%; height: 100%; position: absolute; top: 0px; bottom: 0px; right: 0px; left: 0px;"></video>
			</div></div><ol class="vjs-playlist"></ol>			
<script src="//players.brightcove.net/96980687001/B156LiFr_default/index.min.js"></script>

<script type="text/javascript">
		videojs('player').ready(function(){
			var myPlayer = this,
                videoName,
                playlistData2 = myPlayer.playlist(),
                flag=0;

                //iMax2 = playlistData2.length;

                //console.log('iMax: '+iMax2);
