                                    ...
                                    ?><li>
                                        <div class="client-slice">
                                            ...
                                            <div class='imagen_post'>
                                                <a href="/galerias_page?gallery=<?php echo $id_galeria;?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">                                                <div class="nav__image-icon nav__image-icon--photo"></div>
                                                    <img src="<?php echo $urlImg;?>" width="145" alt="<?php echo $title_gal; ?>" title="<?php echo $title_gal; ?>" /></a>
                                            </div>

                                            <div class='tit_post'>
                                                <a class="entry-text" href="/galerias_page?gallery=<?php echo $id_galeria;?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php echo $title_gal; ?></a>
                                            </div>
