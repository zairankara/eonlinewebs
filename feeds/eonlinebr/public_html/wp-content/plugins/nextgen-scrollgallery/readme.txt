...
This is stable version 1.8.0. I published **version 2.0.0** but the new structure causes massive CSS errors in many themes.
**If you are familiar with css you will profit from the new version**. 2.0.0 beta is stored as beta in the repertory. You can download it at http://wordpress.org/extend/plugins/nextgen-scrollgallery/download/. If you use version 2.0.0 check that the fields "imagearea" and "thumbarea" are **not empty**!

[Read more](http://software.bmo-design.de/scrollgallery/wordpress-plugin-scroll-gallery-2.html) about version 2.
