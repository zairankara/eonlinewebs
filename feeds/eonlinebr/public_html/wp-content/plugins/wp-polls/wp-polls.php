...
function poll_header() {	
	...
	echo "\t".'var polls_text_wait = \''.esc_js(__('Your last request is still being processed. Please wait a while ...', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_text_valid = \''.esc_js(__('Please choose a valid poll answer.', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_text_multiple = \''.esc_js(__('Maximum number of choices allowed:', 'wp-polls')).'\';'."\n";
...
function poll_header_admin() {
	...
	echo "\t".'var polls_admin_text_delete_poll = \''.esc_js(__('Delete Poll', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_no_poll_logs = \''.esc_js(__('No poll logs available.', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_delete_all_logs = \''.esc_js(__('Delete All Logs', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_checkbox_delete_all_logs = \''.esc_js(__('Please check the \\\'Yes\\\' checkbox if you want to delete all logs.', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_delete_poll_logs = \''.esc_js(__('Delete Logs For This Poll Only', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_checkbox_delete_poll_logs = \''.esc_js(__('Please check the \\\'Yes\\\' checkbox if you want to delete all logs for this poll ONLY.', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_delete_poll_ans = \''.esc_js(__('Delete Poll Answer', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_open_poll = \''.esc_js(__('Open Poll', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_close_poll = \''.esc_js(__('Close Poll', 'wp-polls')).'\';'."\n";
	echo '/* ]]> */'."\n";
	echo '</script>'."\n";
...
function poll_footer_admin() {	
	echo '<script type="text/javascript">'."\n";
	echo '/* <![CDATA[ */'."\n";
	echo "\t".'var polls_admin_text_enter_poll_id = \''.esc_js(__('Enter Poll ID', 'wp-polls')).'\';'."\n";
	echo "\t".'var polls_admin_text_enter_poll_id_again = \''.esc_js(__('Error: Poll ID must be numeric', 'wp-polls')).'\n\n'.esc_js(__('Please enter Poll ID again', 'wp-polls')).'\';'."\n";
	...
	echo "\t\t".'edButtons[edButtons.length] = new edButton("ed_poll","'.esc_js(__('Poll', 'wp-polls')).'", "", "","");'."\n";
	...
	echo "\t\t".'qt_button.value = "'.esc_js(__('Poll', 'wp-polls')).'";'."\n";
	echo "\t\t".'qt_button.title = "'.esc_js(__('Insert Poll', 'wp-polls')).'";'."\n";
