jQuery(document).ready(function($) {
    ...
    // add responsive to the videos , iframe[src*="instagram.com"]
    jQuery('iframe[src*="youtube.com"], iframe[src*="player.vimeo.com"], iframe[src*="vine.co"], iframe[src*="c.brightcove.com"]').each(function() {
...
var BCLS = (function(window, document) {
    function traer_data_2(info, jsonData2){
        ...
        for (var i=0; i<cantidad; i++) {
            ...
            var imagenThumb, imagenPoster;
             ...
             //console.log(elemento.custom_fields);
    ...
    function setRequestData(id, playlistID, videoID) {
        ...
        if (id == 'lastUpdated') {
                endPoint = '/videos?&q=tags:destacado_br&sort=-updated_at&limit=10';
