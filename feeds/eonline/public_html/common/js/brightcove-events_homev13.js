videojs.registerPlugin('customEventPlugin', function() {
  ...
  var myPlayer = this,
            ...
            myPlayer.on("pause", function () {
                //console.log('This VIDEO pause v13 ');
            ...
            myPlayer.on("play", function () {
                //console.log('This VIDEO play v13');
                if(parent.document.getElementById('featuredvideo__herotext') !=null ){
             ...
             myPlayer.on("playing", function () {
                //console.log('This playing play v13');
            ...
            myPlayer.on('ads-play',function( evt ){
                //console.log('This ads VIDEO play v13');
            ...
            myPlayer.on('ads-pause',function( evt ){
                ...
                //console.log('This ads VIDEO pause v13');
                if(parent.document.getElementById('featuredvideo__herotext') !=null ){
                    parent.document.getElementById("featuredvideo__herotext").style.display = 'block';
                }
            });
            ...
            myPlayer.on('ads-ad-started',function( evt ){
                //console.log('This ads VIDEO ads-ad-started v13');
