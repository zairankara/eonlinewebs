videojs.plugin('customEventPlugin', function() {
  ...
  var myPlayer = this,
            ...
            myPlayer.on("pause", function () {
                console.log('This VIDEO pause v4 ');
                document.getElementByClass("featuredvideo__herotext").style.display = 'block';
            });

            myPlayer.on("play", function () {
                console.log('This VIDEO play v4 ');
                document.getElementByClass("featuredvideo__herotext").style.display = 'none';
            });

            
             myPlayer.on("playing", function () {
                console.log('This VIDEO playing v4 ');
                document.getElementByClass("featuredvideo__herotext").style.display = 'block';
