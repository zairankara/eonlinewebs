videojs.plugin('customEventPlugin', function() {
  ...
  var myPlayer = this,
            ...
            myPlayer.on("pause", function () {
                console.log('This VIDEO pause v3: ');
                $(".featuredvideo__herotext").show();
            });

            myPlayer.on("play", function () {
                console.log('This VIDEO play v3: ');
                $(".featuredvideo__herotext").hide();
            });

            
             myPlayer.on("playing", function () {
                console.log('This VIDEO playing v3: ');
                $(".featuredvideo__herotext").show();
