<div id="clients" class="galerias_dest_eblogs">
	...
	$galerias = $mydb2->get_results("SELECT efb_1, efb_2, efb_3, efb_4, efb_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

						$id_galeria=$galerias[0]["efb_".$al];
