...
$cfg['Servers'][$i]['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controluser']   = 'uv0257';          // MySQL control user settings
                                                    // (this user must have read-only
$cfg['Servers'][$i]['controlpass']   = 'larra516lacra';          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
                                                    // The controluser is also
                                                    // used for all relational
                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     = 'config';    // Authentication method (config, http or cookie based)?
$cfg['Servers'][$i]['user']          = 'uv0257';      // MySQL user
$cfg['Servers'][$i]['password']      = 'larra516lacra';          // MySQL password (only needed
...
$cfg['Servers'][$i]['user']            = 'uv0257';
$cfg['Servers'][$i]['password']        = 'larra516lacra';
...
$cfg['SQLValidator']['username'] = 'uv0257';      // If you have a custom username, specify it here (defaults to anonymous)
$cfg['SQLValidator']['password'] = 'larra516lacra';      // Password for username
