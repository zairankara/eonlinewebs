...
$cont_del=1;
		...
		{	
			...
			//images.eonline
				$sqlstr=$INS_PICT.' ('.$galleryItem->galleryItem->image->id.', 0, '.$gallery->id.', "http://www.eonline.com'.$galleryItem->galleryItem->image->filePath."/".$galleryItem->galleryItem->image->source.'","'.$titlePicture.'","'.htmlentities($captionIMG).'", '.$num_order.');';
				$this->executeQuery($sqlstr);
