...
<!--<?php if(is_home()){?>
	<meta http-equiv="refresh" content="0;url=http://la.eonline.com/andes/category/alfombraroja">
<?}?>-->
...
if(is_single() && $_COOKIE["mobify-path"]==""){?>
	<script type="text/javascript" src="/mobile/detectar_ANDES.js"></script>
<?}?>-->
...
<?php } elseif(is_category()||is_tag()||is_page()) { ?>
		...
		if(is_category( "enews" )){
			...
			$description_site="Lo &uacute;ltimo en Peliculas. Todo lo que necesitas saber. ".$title_site;
		}elseif ( es_wakeup()) {
...
<script type="text/javascript" src="/admin2012/banners/slider/slides.min.jquery.js"></script>
	<script>
		$(function(){
...
<?php if(is_home()){?>
	...
	<a id="various3" href="/experience/EncuestaNombreShow/index.php?f=1"></a>
<?}?>
-->
...
jQuery(document).ready(function($) {
 ...
 <!--/* ENCUESTA ONLINE  */-->
	...
	<!--/* Defineslots */-->
	<? include(TEMPLATEPATH."/defineslots_andes_dynamic.php");?>
	<!--/* Defineslots */-->
...
<div id="wrapper" class="hfeed">
			  ...
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				...
				<div class="menu-header">
					<ul id="menu-principal" class="menu">
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" href="<?php echo home_url( '/' ); ?>pagina/fotos-andes" OnMouseOver="this.style.borderColor='<?php echo cat_color('fotos');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('fotos');?>; <?if(is_page('fotos-andes')) echo ("border-color:".cat_color('fotos').";");?>">Fotos</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" href="<?php echo home_url( '/' ); ?>category/deportes" OnMouseOver="this.style.borderColor='<?php echo cat_color('deportes');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('deportes');?>; <?if(is_category('deportes')) echo ("border-color:".cat_color('deportes').";");?>">DEPORTES</a></h5>
						</li> 
						<!--<li class="menu-item menu-item-type-post_type menu-item">
	...
	if ($cat_alf2==1 || $cat_alf3==1){?>
	      <style>
			...
			/* PATROCINIO RED CARPET*/
			.category-alfombraroja #submenu  .items_sponsor{
				background: url(<?php echo $var_con[200]; ?>/images/patrocinio_redcarpet_AN.png) no-repeat right; 
			}
			</style>
			<div id="submenu">
			...
			<?if($_GET["debug"]!=""){?>
				<!-- MODULO RED CARPET SEASON LINEUP-->
