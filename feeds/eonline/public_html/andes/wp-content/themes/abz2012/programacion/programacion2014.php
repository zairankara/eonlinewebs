...
<div id="todo_prog">
	...
	<div id="cont_gral">
			...
			<!-- Fecha -->
			<form method="post" action="<?=$var_con[1]?>pagina/programas/" name="ff">
				...
				<div class="cont_menu_dia">
					<ul class="menu_dia">
						...
						<li><a href="#" onclick="variables(3);" title="Miércoles" class="miercoles <?if ($_POST["dia"]=="") {if($dia_letra=="3")echo ("selected");}else{if($_POST["dia"]=="3") echo ("selected");}?>">MIERCOLES</a></li>
			...
			if($rows==""){
				...
				foreach($rows as $row){
						...
						<div class="modulo_prog">
							<div class="<?=$franja?>">
								<div class="hora"><?=$date_hh.":".$date_ii;?><span class="ampm"><?=$ampm?></span></div>
