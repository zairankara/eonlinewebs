	...
	max-width: 550px !important;
		...
		<div id="container">
			...
			<div class="cont_one-clumn" style="background-color: #1a1a1a;padding-top: 20px; margin:10px;">
									...
									<? 
									$url = 'http://adsrv01.eonlinelatinola.com/www/delivery/ajs.php?zoneid=139';
									...
									if($_GET["foto"]%3==0 && $_GET["foto"]!="" && $hay_=="1"){?>
										...
										<div class="banner_slider">
											<script type='text/javascript'><!--// <![CDATA[
											    OA_show(139);
											// ]]> --></script><noscript>
											<a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=6b2cbd6'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=139&amp;n=6b2cbd6' /></a>
											</noscript>
