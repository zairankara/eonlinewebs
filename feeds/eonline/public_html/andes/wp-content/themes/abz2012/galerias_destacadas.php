<div id="clients" style="background-color:#000 !important;">
	...
	$galerias = $mydb2->get_results("SELECT an_1, an_2, an_3, an_4, an_5 FROM abmGalDestacadas", ARRAY_A);
				...
				for($al=1;$al<=5;$al++){
		   		...
		   		<div class="client-slice">
						...
						<div class='tit_post'>
							<a href="<?php echo home_url( '/' ); ?>pagina/fotos-andes" rel="bookmark" style="color:#ff0099; font-size:18px;">Ver más galerias</a>
						</div>
