		...
		<div class="cont_one-clumn" id="paginafotos">
			...
			<br clear="all"/>
					...
					if($_POST["buscar_gal"]!="" && $_POST["flag_gal"]==1){
						...
						//if ($_GET["web"]!="") exit ("string: ".$galleries);
					}else{
						$id_gal=NULL;
					...
					$valor_season = $mydb2->get_results('SELECT mundial_an FROM abmGalDestacadas', ARRAY_A);
					$mundial_an=$valor_season[0]["mundial_an"];
					...
					foreach($galleries as $image){
								...
								if($id_galeria!=$mundial_an && $id_galeria!=12845 && $id_galeria!=7538 && $id_galeria!=13242){
								if($id_galeria!=10076){	
									if($urlImg){?>
