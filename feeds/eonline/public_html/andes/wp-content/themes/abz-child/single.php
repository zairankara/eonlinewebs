    ...
    <div class="swiper-container col-md-9">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="col-md-12 content-area swiper-slide" id="main-column">
                    ...
                    <div id="main-single" class="col-md-9 col-xs-12">
                         ...
                         <!-- PLAYER DE LA HOME CON PLAYLIST B1pqtqxtx -->
                                    ...
                                    data-player="HkfDncW9x"
                                    data-embed="default"
                                    class="video-js"
                                    controls
                                    style="width: 100%; height: 100%; position: absolute; top: 0px; bottom: 0px; right: 0px; left: 0px;"></video>
                                    <script src="//players.brightcove.net/96980687001/HkfDncW9x_default/index.min.js"></script></div></div><ol class="vjs-playlist"></ol>
                                    <style>
                                        #playlist_single{
                                            margin: 10px auto;
                                        }
                                    ...
                                    /*videojs("player_html5_api").ready( function() {
                                        ...
                                        setTimeout(function(){
                                            myPlayer.play();
                                            jQuery(".debug-video").html("play 12.32");
                                        }, 8000);

                               
                                        videojs("player_html5_api").ready( function() {
                                            document.querySelector('#player_html5_api').play();
                                            console.log("player_html5_api");
                                        }); */
                        ...
                        <div id="related-single" class="col-md-3 col-xs-12" data-mostrarMobile="0" style="display:none;">
                            ...
                            <!-- MAS LEIDOS-->
                            <?php
                            $url = '../varios/JSON/JSONanalytics/andes.json';
        ...
        <script type="text/javascript">
            /*jQuery(document).ready(function($) {
                ...
                if( $( 'body' ).hasClass( 'postid-830564' ) ){

                    $( '.entry-content p' ).children(':eq(8)').after( '<a href="https://www.facebook.com/EstiloTRESemme/videos/1845838059000594/?permPage=1" target="_blank"><img src="http://la.eonline.com/andes/wp-content/themes/abz-child/assets/360.jpg"></a>' );

                }

                if( $( 'body' ).hasClass( 'postid-864035' ) ){

                    $( '#playlist_single' ).before( '<a href="//www.youtube.com/watch?v=Otc1N_NX8iQ" target="_blank"><img src="http://la.eonline.com/andes/wp-content/themes/abz-child/assets/360-v3.jpg"></a>' );
