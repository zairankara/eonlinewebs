<?php if(is_home() || is_category()){?>
                      ...
                      <? //echo quien_es("310","30",$post->ID);?>
											...
											<div class="entry-content2 <?if(is_sticky()) echo "destacado";?>">
                        ...
                        <div class="social-icons-small" data-url="<?php the_permalink() ?>?utm_campaign=VisitorShare" data-title="<?php echo $post->post_title; ?>">
                                <div class="social-icon facebook">
                                  <a class="social-fb" target="_blank" onclick="share('Facebook','http://www.facebook.com/sharer/sharer.php?u=<?php the_permalink() ?>?utm_campaign=VisitorShare', '<?php echo $post->post_title; ?>', 'Article');" href="javascript:void(0);"></a>
                                </div>
                                <div class="social-icon twitter">
                                  <a class="social-tw" onclick="share('Twitter', 'https://twitter.com/share?text=<?php echo $post->post_title; ?>&url=<?php the_permalink(); ?>?utm_campaign%3DVisitorShare', '<?php echo $post->post_title; ?>', 'Article')" href="javascript:void(0);" ></a>
                                </div>
                        </div>
                        <!-- / REDES SOCIALES POR POST-->
