...
if($_GET["attachment_id"]!="" and is_numeric($_GET["attachment_id"])){
	...
	Header( "Location: http://la.eonline.com/argentina/" );
}
?>
...
if(is_single() && $_COOKIE["mobify-path"]==""){?>
	...
	<!--<script type="text/javascript" src="/mobile/detectar_ARGENTINA.js"></script>-->
<?}?>

<!-- CAMBIO DE HOME A RED CARPET-->
 <!--<?php if(is_home()){?>
	<meta http-equiv="refresh" content="0;url=http://la.eonline.com/argentina/category/alfombraroja">
<?}?>-->
...
<?php //include(TEMPLATEPATH."/detectar_movil.php"); ?>
...
$default_img = $var_con[1]."wp-content/themes/abz2012/images/generica_blanca.jpg";
...
<?php } elseif(is_category()||is_tag()||is_page()) { ?>
		...
		}elseif(is_page("zonatrendyargentina")){
			$title_site="Zona Trendy Argentina | ".$feed_site;
			$description_site="Si deseas contemplar muy de cerca el lifestyle de las celebridades y la socialité Argentina, Soledad Aniesa te lleva a conocerlo.";
...
<?php } else { ?>
		...
		<? 
		$title_site="E! Online Latino | Argentina";
		$description_site="E! Latinoamérica. Todo el mundo del espectáculo y la cultura Pop en vivo desde Hollywood. ".$title_site;
		?>
		<title><?php echo $title_site ?></title>
		<meta name="description" content="<?php echo $description_site ?>" />
...
<script type="application/ld+json" data-device="1">
    {
      ...
      "author": "https://plus.google.com/109640549139413649832?rel=author",
	  "image": "<?php echo trim($default_img) ;?>",
...
<!--CSS CYCLE-->
<link rel="stylesheet" type="text/css" href="/common/cycle-slider/cycle.css" />
...
<?php }  elseif ( is_page( "fotos-argentina" )  || is_page( "galerias" )) {?>
...
<?php }  elseif ( is_category( "princesa_maxima" )) {?>
	<!--<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $var_con[200]; ?>/style_seccion.css" />-->
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $var_con[200]; ?>/style_maxima.css" />
...
<?if( is_page("beta") ):?>
<script type="text/javascript" src="http://la.eonline.com/common/msCarousel/jquery.msCarousel-min.js"></script>
<link rel="stylesheet" type="text/css" href="/common/msCarousel/mscarousel_2014_v2_old.css" />
<?php endif; ?>


<?if( is_page("fotos_new") ):?>
	<link rel="stylesheet" href="<?php echo $var_con[200]; ?>/paginator/css/jPages.css">
	<link rel="stylesheet" href="<?php echo $var_con[200]; ?>/paginator/css/animate.css">

    <script type="text/javascript" src="<?php echo $var_con[200]; ?>/paginator/js/highlight.pack.js"></script>
    <script type="text/javascript" src="<?php echo $var_con[200]; ?>/paginator/js/tabifier.js"></script>
    <script src="<?php echo $var_con[200]; ?>/paginator/js/js.js"></script>
	<script src="<?php echo $var_con[200]; ?>/paginator/js/jPages.js"></script>
    ...
    <style type="text/css">
		...
		.arrowPrev, .arrowNext { width:29px; height:29px; position: absolute; top: 135px;cursor: pointer; }
		.arrowPrev { background-image: url('<?php echo $var_con[200]; ?>/paginator/img/back.gif'); left: 0; }
		.arrowNext { background-image: url('<?php echo $var_con[200]; ?>/paginator/img/next.gif'); right: 0; }
...
<script async type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js" data-device="1"></script>
...
<!-- PREDICTIVE SEARCH -->
<script defer="defer" src="/common/psearch/jquery-ui-1.10.4.custom.min.js"></script>
...
<?php if(is_home()){?>
	...
	<a id="various3" href="/experience/EncuestaNombreShow/index.php?f=2"></a>
<?}?>
-->
...
<!-- <?php if(is_home() && $_COOKIE['voted_poll_new']!="1"){?>
	<style type="text/css">
	#fancybox-content, #fancybox-outer{
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
			//console.log( "asasas".$.cookie("voted_poll_new") );
			$("#various3").fancybox().trigger('click');
		});
	</script>
...
jQuery(document).ready(function($) {
 ...
 <!--/* ENCUESTA ONLINE  */-->
	...
	<!--/* Defineslots */-->
	<? include(TEMPLATEPATH."/defineslots_argentina_dynamic.php");?>
	<!--/* Defineslots */-->
	...
	<?if(is_home() || is_category()){?>	
			...
			<script defer="defer" src="/common/AnimOnScroll/modernizr.custom.js"></script>
			<script defer="defer" src="/common/AnimOnScroll/masonry.pkgd.min.js"></script>
			<script defer="defer" src="/common/AnimOnScroll/imagesloaded.pkgd.min.js"></script>
			<script defer="defer" src="/common/AnimOnScroll/classie.js"></script>
			<script defer="defer" src="/common/AnimOnScroll/AnimOnScroll.js"></script>
...
<body id="argentina" <?php body_class(); ?> <?if($title_post) echo ('data-title="'. utf8_decode($title_post).'"');?>>
...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
		...
		<div id="masthead" class="default" itemscope itemtype="http://schema.org/Organization">
			<!-- CABEZAL LOGO -->
			<<?=$h_logo?> id="site-title">
				<span>
					<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" itemprop="url"><?php bloginfo( 'name' ); ?></a>
				</span>
			</<?=$h_logo?>>
			<!-- / CABEZAL LOGO -->
				...
				<div class="menu-header">
					<ul id="menu-principal" class="menu">
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="enews" href="<?php echo home_url( '/' ); ?>category/enews/" OnMouseOver="this.style.borderColor='<?php echo cat_color('enews');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('enews');?>; <?if(is_category('enews')) echo ("border-color:".cat_color('enews').";");?>">News</a></h5>
						</li>
						<!--<li class="menu-item menu-item-type-post_type menu-item">
						...
						<li class="menu-item menu-item-type-post_type menu-item" style="padding-bottom:30px;">
							<h5><a class="menu-item-a" data-seccion="eshows" href="<?php echo home_url( '/' ); ?>pagina/eshows" OnMouseOver="this.style.borderColor='<?php echo cat_color('eshows');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('eshows');?>; <?if(is_page('eshows')) echo ("border-color:".cat_color('eshows').";");?>">E! shows</a></h5>
						...
						<li data-category="alfombraroja" class="menu-item menu-item-type-post_type menu-item" style="padding-bottom:30px;">
							<h5><a class="menu-item-a" data-seccion="alfombraroja" href="<?php echo home_url( '/' ); ?>category/alfombraroja" OnMouseOver="this.style.borderColor='<?php echo cat_color('alfombraroja');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('alfombraroja');?>; <?if(is_category('alfombraroja')) echo ("border-color:".cat_color('alfombraroja').";");?>">alfombra roja</a></h5>
							<?include(TEMPLATEPATH."/submenuRC.php");?>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="fotos-argentina" href="<?php echo home_url( '/' ); ?>pagina/fotos-argentina" OnMouseOver="this.style.borderColor='<?php echo cat_color('fotos');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('fotos');?>; <?if(is_page('fotos-argentina')) echo ("border-color:".cat_color('fotos').";");?>">Fotos</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="videos-2" href="<?php echo home_url( '/' ); ?>pagina/videos-2" OnMouseOver="this.style.borderColor='<?php echo cat_color('videos-2');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('videos-2');?>; <?if(is_page('videos-2')) echo ("border-color:".cat_color('videos-2').";");?>">Videos</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="programas" href="<?php echo home_url( '/' ); ?>pagina/programas" OnMouseOver="this.style.borderColor='<?php echo cat_color('programas');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('programas');?>; <?if(is_page('programas')) echo ("border-color:".cat_color('programas').";");?>">Programación</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="lol" href="<?php echo home_url( '/' ); ?>category/lol" OnMouseOver="this.style.borderColor='<?php echo cat_color('lol');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('lol');?>; <?if(is_category('lol')) echo ("border-color:".cat_color('lol').";");?>">LOL</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a"  data-seccion="efashionblogger" href="<?php echo home_url( '/' ); ?>category/efashionblogger" OnMouseOver="this.style.borderColor='#fff';"  
							OnMouseOut="this.style.borderColor='#000';" style="color:#fff; <?if(is_category('efashionblogger')) echo ("border-color:'#fff';");?>">Fashion</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="thetrend" href="<?php echo home_url( '/' ); ?>category/thetrend" OnMouseOver="this.style.borderColor='<?php echo cat_color('thetrend');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('thetrend');?>; <?if(is_category('thetrend')) echo ("border-color:".cat_color('thetrend').";");?>">The Trend</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="the-kardashians" href="<?php echo home_url( '/' ); ?>category/the-kardashians" OnMouseOver="this.style.borderColor='<?php echo cat_color('the-kardashians');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('the-kardashians');?>; <?if(is_category('the-kardashians')) echo ("border-color:".cat_color('the-kardashians').";");?>">Kardashians</a></h5>
						</li>
						
						<!--<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="wakeup" href="<?php echo home_url( '/' ); ?>category/wakeup" OnMouseOver="this.style.borderColor='<?php echo cat_color('wakeup');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('wakeup');?>; <?if(is_category('wakeup')) echo ("border-color:".cat_color('wakeup').";");?>">Wake Up</a></h5>
						</li>-->
						
						<!--<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="glamcam360" href="<?php echo home_url( '/' ); ?>pagina/glamcam360" OnMouseOver="this.style.borderColor='<?php echo cat_color('glamcam360');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('glamcam360');?>; <?if(is_category('glamcam360')) echo ("border-color:".cat_color('glamcam360').";");?>">GlamCam 360</a></h5>
						</li>-->
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="musica" href="<?php echo home_url( '/' ); ?>category/musica" OnMouseOver="this.style.borderColor='<?php echo cat_color('glamcam360');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('glamcam360');?>; <?if(is_category('musica')) echo ("border-color:".cat_color('glamcam360').";");?>">Música</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="deportes" href="<?php echo home_url( '/' ); ?>category/deportes" OnMouseOver="this.style.borderColor='<?php echo cat_color('enews');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('enews');?>; <?if(is_category('enews')) echo ("border-color:".cat_color('enews').";");?>">DEPORTES</a></h5>
						</li>

						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="amamos-las-pelis" href="<?php echo home_url( '/' ); ?>category/amamos-las-pelis" OnMouseOver="this.style.borderColor='<?php echo cat_color('amamos-las-pelis');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('amamos-las-pelis');?>; <?if(is_category('amamos-las-pelis')) echo ("border-color:".cat_color('amamos-las-pelis').";");?>">Pelis</a></h5>
						</li>

						<!--<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a class="menu-item-a" data-seccion="the-royals" href="<?php echo home_url( '/' ); ?>category/the-royals" OnMouseOver="this.style.borderColor='<?php echo cat_color('the-royals');?>';"  OnMouseOut="this.style.borderColor='#000';" style="color:<?php echo cat_color('the-royals');?>; <?if(is_category('the-royals')) echo ("border-color:".cat_color('the-royals').";");?>">The Royals</a></h5>
						</li>-->
	  ...
	  if ($cat_alf2==1 || $cat_alf3==1){?>
	     <style>
			...
			.category-alfombraroja #submenu  .items_sponsor{
				background: url(<?php echo $var_con[200]; ?>/images/patrocinio_redcarpet_AR.png) no-repeat right;
			}
