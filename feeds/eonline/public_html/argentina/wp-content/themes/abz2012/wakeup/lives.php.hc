					<!-- LIVESTREAMING-->
						...
						$abmLivesRows_url=str_replace("home.php", "home_ar.php", $abmLivesRows_is_category);
						...
						if($abmLivesRows==1 && $abmLivesRows_is_category=="wakeup"){?>
							<div style="margin-left:20px; margin-top:10px; margin-bottom:10px; width:620px; height:400px;border:5px solid #000;">
								<iframe src="http://la.eonline.com/experience/wakeup/home_ar.php" width="615" height="400" scrolling="no" frameborder="0" allowtransparency="allowtransparency"></iframe>
							</div>
