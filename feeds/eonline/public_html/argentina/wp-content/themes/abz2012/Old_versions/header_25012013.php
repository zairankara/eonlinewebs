...
$default_img = "http://la.eoline.com/argentina/wp-content/themes/abz2012/images/generica_blanca.jpg";
...
<?if( is_page("fotos_new") ):?>
    ...
    <style type="text/css">
		...
		.arrowPrev { background-image: url('<?php bloginfo('template_url')?>/paginator/img/back.gif'); left: 0; }
		.arrowNext { background-image: url('<?php bloginfo('template_url')?>/paginator/img/next.gif'); right: 0; }
