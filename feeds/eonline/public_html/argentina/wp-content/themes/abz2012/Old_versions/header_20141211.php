...
<html lang="es" xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" itemscope itemtype="http://schema.org/Organization" >
<head>
...
<!-- FACEBOOK OPENGRAPH -->
	...
	$default_img = "/argentina/wp-content/themes/abz2012/images/generica_blanca.jpg";
...
jQuery(document).ready(function($) {
 ...
 <!--/* ENCUESTA ONLINE  */-->
	...
	<!--/* Defineslots */-->
	<? include(TEMPLATEPATH."/defineslots_argentina.php");?>
	<!--/* Defineslots */-->
			  ...
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				...
				<div class="menu-header">
					<ul id="menu-principal" class="menu">
						...
						<li class="menu-item menu-item-type-post_type menu-item">
							<h5><a href="<?php echo home_url( '/' ); ?>pagina/fotos-argentina" OnMouseOver="this.style.borderColor='<?php echo cat_color('fotos');?>';"  OnMouseOut="this.style.borderColor='#000';"  style="color:<?php echo cat_color('fotos');?>; <?if(is_page('fotos-argentina')) echo ("border-color:".cat_color('fotos').";");?>">Fotos</a></h5>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item">
...
.borde_billboard_banner{
	...
	<?if(is_home()){?>
		<!-- Banner Billboard-->
		<div id="div-gpt-ad-home-970x31" class="borde_billboard_banner " >
				<script type="text/javascript">
		...
		<!-- /Banner Billboard-->
		<!-- Banner pushdown-->
		<div id="div-gpt-ad-home-970x90" class="borde_billboard_banner ">
				<script type="text/javascript">
		...
		<!-- / Banner pushdown-->
		<!-- Banner Slider-->
		<!--<div id="div-gpt-ad-home-slider" class=''>
				<script type="text/javascript">
	  ...
	  if ($cat_alf2==1 || $cat_alf3==1){?>
	     <style>
			...
			/*.category-alfombraroja #submenu  .items_sponsor{
				background-image: url(<?php echo $var_con[200]; ?>/images/patrocinio_redcarpet_AR_sally.png);
			}*/
