...
function getTopVideos_IB() {
  ...
  //despues de las funciones getTop
...
function traer_data_2(info, jsonData2){
  ...
  for (var i=0; i<jsonData2["videos"].length; i++) {
    ...
    if(!first){
      ...
      if (i==0 && info=="resp_HM") cargar(first);
		...
		<div id="container" class="one-column">
          ...
          <?if($_GET["web"]==""){?>
                 <div id="carrousel_MV" class="tira_chica">
                   ...
                   <div style="width:570px;float:left;margin-bottom:10px;">
                  
                        <div id="destino" style="width:570px;height:400px;float:left;overflow:hidden;">
                          <?
                          if($_GET['id']!=""){
                            $Video=$_GET['id'];
                          }else{
                        ...
                        <div style="width:570px;height:280px;float:left;overflow:hidden;background:#272727;">
