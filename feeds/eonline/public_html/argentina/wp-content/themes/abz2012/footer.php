						...
						<div style="margin-right:10px; margin-top: 7px; float:right;">
						   ...
						   echo <<<EOT
								<div itemscope itemtype="http://schema.org/WebSite">
									...
									<form itemprop="potentialAction" itemscope itemtype="http://schema.org/SearchAction" method="get" id="searchform" class="searchform" action="$escape_url">
										<div role="search">
...
?>
						...
						<div style="margin-right:10px; margin-top: 10px; float:right;">
							<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2FEonlinelatino&layout=button_count&show_faces=true&width=120&action=like&colorscheme=light" height="30" style="border:none;overflow:hidden;width:120px;height:30px;text-align:center;"></iframe>							
						</div>
