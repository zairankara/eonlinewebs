	...
	$(function(){
		...
		$("#imgImageSig").html('<img src="'+fruits[1]+'" id="imgsrc_sig" title="'+tit_text[1]+'" alt="'+tit_text[1]+'"/>');  
 		 ...
 		 /* $('meta[property="og:type"]').remove();
 		  ...
 		  $("head").append('<meta property="og:type" content="image">');
 		  $("head").append('<meta property="og:title" content="<?=$galleries2[0]["title_gal"]?>">');
		  $("head").append('<meta property="og:description" content="'+tit_text[0]+'">');
		  $("head").append('<meta property="og:image" content="'+fruits[0]+'">');*/
