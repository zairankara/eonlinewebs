<?php if(is_category("the-kardashians")){?>
	<h3 style="margin-top:8px;"><a href="<?php echo home_url( '/' ); ?>category/the-kardashians" class="widget-title" style="color:#FF9C00">THE KARDASHIANS TODAY´S PIC</a></h3>


<div id="fotosKardashians">
