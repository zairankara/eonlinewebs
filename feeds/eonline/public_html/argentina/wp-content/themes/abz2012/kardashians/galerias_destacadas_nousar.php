<div id="clients" class="galerias_dest_kardashians">
	<div class="entry-utility">
		<h3 style="background-color: <?php echo cat_color($name_cat);?> !important;">GALERIAS DE LAS KARDASHIANS</h3>
	</div>
	...
	$galerias = $mydb2->get_results("SELECT tk_1, tk_2, tk_3, tk_4, tk_5 FROM abmGalDestacadas", ARRAY_A);

	for($al=1;$al<=5;$al++){

			$id_galeria=$galerias[0]["tk_".$al];
