...
if($gallery!=""){
    ...
    exit('<span class="alert alert-danger" style="left: 50%; top: 50%; position: absolute;">No se encuentra la Galeria<br><a href="/argentina/pagina/fotos-argentina" class="btn btn-default">Volver</a></span>');
}
?>
