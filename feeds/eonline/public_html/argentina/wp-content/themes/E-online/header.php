...
if(is_single() || is_page( ) || is_attachment()){
	$id_post="reader.php?f=2&id=".get_the_ID();
}else{
	$id_post="parser.php?f=2";
}
...
<meta name="identifier-url" content="http://la.eonline.com/">
<meta name="Language" content="Spanish">
<meta name="Distribution" content="Global">
<meta name="revisit-after" content="1 day">
<meta name="Category" content="entertainment">
<link rel="shortcut icon" href="http://la.eonline.com/argentina/wp-content/themes/E-online/images/favicon.ico"/>
...
<!-- ADSERVER -->
 <script type='text/javascript' src='http://adsrv01.eonlinelatinola.com/www/delivery/spcjs.php?id=1'></script>
...
/*jQuery(document).ready(function() {
	$.fancybox(
		'<div><IMG SRC="http://la.eonline.com/andes/wp-content/themes/E-online/images/comunes/kourtneyTNY.gif" whidth="480" height="52" BORDER="0" ALT=""></div><div style="margin-top:5px;"><div style="display:none"></div><object id="myExperience1537362437001" class="BrightcoveExperience"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="480" /><param name="height" value="270" /><param name="playerID" value="773795205001" /><param name="playerKey" value="AQ~~,AAAAFpR_2Jk~,FZYC7qwaTWPZRpAgEIVYABg4ulQxTkb-" /><param name="isVid" value="true" /><param name="isUI" value="true" /><param name="dynamicStreaming" value="true" /><param name="@videoPlayer" value="1537362437001" /></object></div>',{
...
<?}
if( is_category( "cine_by_dos_equis") || ( in_category( "cine_by_dos_equis" )==1 && ! is_home()  &&  is_single())){?>
...
<script type='text/javascript'><!--//<![CDATA[
   var ox_u = 'http://adsrv01.eonlinelatinola.com/www/delivery/al.php?zoneid=105&target=_blank&cb=INSERT_RANDOM_NUMBER_HERE&layerstyle=simple&align=center&valign=middle&padding=0&closetime=20&padding=0&shifth=0&shiftv=0&closebutton=t&nobg=t&noborder=t';
...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
		...
		<div id="cont_search_banners">
			<div id="buscador_top">
			<ul id="menu_top">
				<li><a href="http://la.eonline.com/argentina/index.php">Inicio</a> | </li>
				<li><a href="http://la.eonline.com/argentina/contacto/">Contacto</a> | </li>
			...
			<div id="cont_banners_top" style="z-index:100; position:absolute; top:auto; left:auto;">
				
				<div style="width: 240px; height: 90px; float: left;margin-right:10px;">
				...
				<div id="exp_banner" style="width: 720px; height: 90px; float: left; overflow:hidden;">
					<?php
			...
			<div id="paises" style="z-index: 10; position:absolute; top:130px; left:auto;">
			...
			<div id="branding" role="banner">
				...
				<div id="destacados_H">
					...
					function fecha (){
						...
						//echo("<input type='hidden' name='debugValue' value=''>");
						//echo("<pre>".print_r($vect)."</pre>");
						return $vect_dia[$vect[wday]];
					}

					//$dia_semana= fecha();

					//echo("<input type='hidden' name='debug1' value='".$dia_semana."'><input type='hidden' name='debug2' value='".print_r(getdate())."'><input type='hidden' name='debug3' value='".$vect[wday]."'>");
					...
					$sqlstr="SELECT *
					FROM abmBanners
					WHERE id_feed=2 AND activo=1 AND newdesign=0 AND ( dia=CURDATE() OR ".$dia_semana."=1) ORDER by fecha DESC";
					...
					foreach ($testRows as $row) {
						...
						?><li><a href="<?=$link?>" target="<?=$target?>"><img src="http://la.eonline.com/admin2012/banners/uploads/<?=$id_banner?>.jpg?rnd<?=rand(1,1000000);?>"  /></a>
