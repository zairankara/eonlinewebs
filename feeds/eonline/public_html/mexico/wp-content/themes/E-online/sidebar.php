								...
								<div style='height:170px; _height:180px; overflow-y:auto; width:300px; background:#fff; padding-top:10px;'>
											...
											<div style="width:130px; margin-left:5px; padding-bottom:10px; float:left;">
													...
													<tr>
														...
														<A HREF="http://www.eonlineexperiences.com/la_sopa" target="_blank"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/celebridades/eduardo_videgaray.jpg" alt="" width="90" border="0" /></A></div></td>
													</tr>
													<tr>
														<td class="mod_chico_programa" style="text-align:center;" ><A HREF="http://www.eonlineexperiences.com/la_sopa" target="_blank" style="text-decoration:none;">Eduardo Videgaray</A></td>
													</tr>
													</table>
											</div>
											...
											<div style="width:130px;margin-left:5px; padding-bottom:10px; float:left;">
													...
													<tr>
														<td valign="top" width="130" align="center"> <div style="width:90px; height:54px; overflow:hidden;" class="shadow">
														<A HREF="" target="_blank"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/celebridades/john_paul_ospina.jpg" alt="" width="90" border="0" /></A></div></td>
													</tr>
													<tr>
														<td class="mod_chico_programa" style="text-align:center;" ><A HREF="" target="_blank" style="text-decoration:none;">John Paul Ospina</A></td>
													</tr>
													</table>
											</div>
											...
											<div style="width:130px;margin-left:5px; padding-bottom:10px; float:left;">
													...
													<tr>
														<td valign="top" width="130" align="center"> <div style="width:90px; height:54px; overflow:hidden;" class="shadow">
														<A HREF="" target="_blank"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/celebridades/norelys_rodriguez.jpg" alt="" width="90" border="0" /></A></div></td>

													</tr>
													<tr>
														<td class="mod_chico_programa" style="text-align:center;" ><A HREF="" target="_blank" style="text-decoration:none;">Norelys Rodríguez</A></td>
													</tr>
													</table>
											</div>
											...
											<!-- <div style="width:130px;margin-left:5px; padding-bottom:10px; float:left;">
													...
													<tr>
														<td valign="top" width="130" align="center"> <div style="width:90px; height:54px; overflow:hidden;" class="shadow">
														<A HREF="" target="_blank"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/E-online/celebridades/max_villegas.jpg" alt="" width="90" border="0" /></A></div></td>

													</tr>
													<tr>
														<td class="mod_chico_programa" style="text-align:center;" ><A HREF="" target="_blank" style="text-decoration:none;">Max Villegas</A></td>
													</tr>
													</table>
											</div> -->
