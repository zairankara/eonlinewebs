...
<?php 
		...
		while ( have_posts() ) : the_post(); ?>
						...
						<!--<?php if ( is_home() && $i==0 ){?>
								...
								<a href="http://www.eonlineexperiences.com/avengers/LA/" target="_blank"><img src="<?php bloginfo('template_url')?>/images/comunes/toppost_MEX.jpg" alt="" width="590" height="116" border="0"></a></div>
						<?}?>-->
...
<!-- MODULO COUNTER -->
						...
						?>
								<?php if (is_home() && $i==0 ){?>
										  ...
										  <div style="z-index:1; margin-left:10px; margin-bottom:10px; width:590px; height:172px; background: url(http://la.eonline.com/mexico/wp-content/themes/E-online/images/comunes/counter_nuevo.jpg) no-repeat; border:0px solid red; position:relative; ">
						...
						<?php if ( $i==0 ){?>
								...
								<script type='text/javascript'><!--// <![CDATA[
								    OA_show(39);
								// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=d59ed94'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=39&amp;n=d59ed94' /></a></noscript>
								</div>
						<?}?>
						<!-- ADSERVER TOPPOST-->
						...
						<div style="margin-top:5px; margin-left:10px; margin-bottom:5px">
						 <script type='text/javascript'><!--// <![CDATA[
						OA_show(45);
						// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=7b86a90'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=45&amp;n=7b86a90' /></a></noscript>
						</div>
						<?}?>
						 <!--  ADSERVER TOPPOST-->
						...
						<?php if ( !is_home() && is_category("latinbillboard") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_gobe_MEX.gif" alt="" width="593" height="64" border="0"></div>
						<?}?> 

						<?php if ( !is_home() && is_category("alfombraroja") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_gobe_MEX.gif" alt="" width="593" height="64" border="0"></div>
						<?}?> 
