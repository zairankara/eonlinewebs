...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<div id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Entradas Anteriores', 'twentyten' ) ); ?></div>
...
<?php 
		...
		while ( have_posts() ) : the_post(); ?>
						...
						<?php if ( is_home() && $i==0 ){?>
								...
								<a href="http://la.eonline.com/concursos/chinoynacho/" target="_blank"><img src="<?php bloginfo('template_url')?>/images/chinoynacho_mexico.jpg" alt="" width="590" height="116" border="0"></a></div>
						<?}?>
						-->
						...
						$ruta_cache=$_SERVER["DOCUMENT_ROOT"]."mexico/wp-content/cache/";
						...
						<?php if ( $i==0 ){?>
								...
								//]]>--></script><noscript><a href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=a2ce7fa7&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=39&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a2ce7fa7' border='0' alt='' /></a></noscript>
								</div>
						<?}?>
						<!-- ADSERVER TOPPOST-->
						...
						<div style="margin-top:5px; margin-left:10px; margin-bottom:5px">
						 <script type='text/javascript'><!--//<![CDATA[
						   ...
						   if (document.mmm_fo) document.write ("&amp;mmm_fo=1");
						   document.write ("'><\/scr"+"ipt>");
						//]]>--></script><noscript><a href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=a3888e70&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=84&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a3888e70&amp;ct0=INSERT_CLICKURL_HERE' border='0' alt='' /></a></noscript>
					</div>
					<?}?>
						 <!--  ADSERVER TOPPOST-->
						...
						<!-- ADSERVER POST 1-->
						<?php if ( !is_home() && $i==1 && (is_category("enews") || is_category("estrenos")) ){?>
								<div style="margin-top:10px; margin-left: 30px !important; margin-bottom:10px; width:500px; height:90px;">
								<script type='text/javascript'><!--//<![CDATA[
  								var m3_u = (location.protocol=='https:'?'https://adsrv01.eonlinelatinola.com/www/delivery/ajs.php':'http://adsrv01.eonlinelatinola.com/www/delivery/ajs.php');
   								var m3_r = Math.floor(Math.random()*99999999999);
  								if (!document.MAX_used) document.MAX_used = ',';
  								...
  								if (document.mmm_fo) document.write ("&amp;mmm_fo=1");
  								 document.write ("'><\/scr"+"ipt>");
								//]]>--></script><noscript><a href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=a1435c5f&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=45&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a1435c5f' border='0' alt='' /></a></noscript>
								</div>
						<?}?>
						<!-- ADSERVER TOPPOST POS1-->

						 <?php if ( !is_home() && is_category("sag") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_gobe_MEX.gif" alt="" width="593" height="63" border="0"></div>
						<?}?> 
					...
					<!--	
						...
						<?php if ( !is_home() && is_category("oscar") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_oscar_AND_MEX.gif" alt="" width="593" height="63" border="0"></div>
						<?}?>

						<?php if ( !is_home() && is_category("latinbillboard") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_latin_MEX.jpg" alt="" width="593" height="64" border="0"></div>
						<?}?> -->
