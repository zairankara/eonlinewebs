...
if(is_single() || is_page( ) || is_attachment()){
	$id_post="reader.php?f=3&id=".get_the_ID();
}else{
	$id_post="parser.php?f=3";
}
...
<link rel="shortcut icon" href="http://la.eonline.com/mexico/wp-content/themes/E-online/images/favicon.ico"/>
...
<!-- ADSERVER -->
<script type='text/javascript' src='http://adsrv01.eonlinelatinola.com/www/delivery/spcjs.php?id=4'></script>
...
<script type='text/javascript'><!--//<![CDATA[
   var ox_u = 'http://adsrv01.eonlinelatinola.com/www/delivery/al.php?zoneid=106&target=_blank&cb=INSERT_RANDOM_NUMBER_HERE&layerstyle=simple&align=center&valign=middle&padding=0&closetime=20&padding=0&shifth=0&shiftv=0&closebutton=t&nobg=t&noborder=t';
...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
		...
		<div id="cont_search_banners">
			<div id="buscador_top">
			<ul id="menu_top">
				<li><a href="http://la.eonline.com/mexico/">Inicio</a> | </li>
				<li><a href="http://la.eonline.com/mexico/contacto/">Contacto</a> | </li>
		...
		<div id="masthead">
			...
			<div id="branding" role="banner">
				...
				<div id="destacados_H">
					...
					$sqlstr="SELECT *
					FROM abmBanners
					WHERE id_feed=3 AND activo=1 AND newdesign=0 AND ( dia=CURDATE() OR ".$dia_semana."=1) ORDER by fecha DESC";
					...
					foreach ($testRows as $row) {
						...
						?><li><a href="<?=$link?>" target="<?=$target?>" <?=$var_on;?>><img src="http://la.eonline.com/admin2012/banners/uploads/<?=$id_banner?>.jpg"  /></a>
