...
if(is_home() || is_search() || is_tag()){
				...
				if(is_single()){
					...
					switch($postSlug){
						...
						break;
						case "cuidate-de-la-camara":
							$name_sectionDFP="Cuidatedelacamara";
							$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Cuidatedelacamara/BoxBanner_1', [300, 250], 'div-gpt-ad-cuidate-de-la-camara-300x250-1').addService(googletag.pubads());
										googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Cuidatedelacamara/Header_Chico', [240, 90], 'div-gpt-ad-cuidate-de-la-camara-240x90').addService(googletag.pubads());
										googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Cuidatedelacamara/LeaderBoard', [728, 90], 'div-gpt-ad-cuidate-de-la-camara-728x90').addService(googletag.pubads());
										googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Cuidatedelacamara/Floating_3ros', 'div-gpt-ad-cuidate-de-la-camara-floating_3ros').addService(googletag.pubads());";
						break;
						// FALTA DEFAULT HOME
					}
				...
				switch($postSlug){
					...
					case "fotos-mexico":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/BoxBanner_1', [300, 250], 'div-gpt-ad-fotos-mexico-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Header_Chico', [240, 90], 'div-gpt-ad-fotos-mexico-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fotos/LeaderBoard', [728, 90], 'div-gpt-ad-fotos-mexico-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Fotos/Floating_3ros', 'div-gpt-ad-fotos-mexico-floating_3ros').addService(googletag.pubads());";
					break;
					case "galerias":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Galerias/BoxBanner_1', [300, 250], 'div-gpt-ad-galerias-300x250-1').addService(googletag.pubads()).setTargeting('galleryid', ".$idGallery.");
									...
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Galerias/Header_Chico', [240, 90], 'div-gpt-ad-galerias-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Galerias/LeaderBoard', [728, 90], 'div-gpt-ad-galerias-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Galerias/Floating_3ros', 'div-gpt-ad-galerias-floating_3ros').addService(googletag.pubads());";
					break;
					case "fashionpolicemx":
						$name_sectionDFP="Fashion_Police";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fashion_Police/BoxBanner_1', [300, 250], 'div-gpt-ad-fashionpolicemx-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fashion_Police/Header_Chico', [240, 90], 'div-gpt-ad-fashionpolicemx-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Fashion_Police/LeaderBoard', [728, 90], 'div-gpt-ad-fashionpolicemx-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Fashion_Police/Floating_3ros', 'div-gpt-ad-fashionpolicemx-floating_3ros').addService(googletag.pubads());";
					break;
					case "fashionpolice":
						$name_sectionDFP="Fashion_Police";
					...
					case "zonatrendymexico":
						...
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/BoxBanner_1', [300, 250], 'div-gpt-ad-zonatrendymexico-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/Header_Chico', [240, 90], 'div-gpt-ad-zonatrendymexico-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/LeaderBoard', [728, 90], 'div-gpt-ad-zonatrendymexico-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Zona_Trendy/Floating_3ros', 'div-gpt-ad-zonatrendymexico-floating_3ros').addService(googletag.pubads());";
					break;
					case "epop":
					...
					break;
					case "lasopamexico":
						$name_sectionDFP="La_Sopa";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/BoxBanner_1', [300, 250], 'div-gpt-ad-lasopamexico-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Header_Chico', [240, 90], 'div-gpt-ad-lasopamexico-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/LeaderBoard', [728, 90], 'div-gpt-ad-lasopamexico-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Floating_3ros', 'div-gpt-ad-lasopamexico-floating_3ros').addService(googletag.pubads());";
					break;
					case "elincorrecto":
						$name_sectionDFP="El_Incorrecto";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/BoxBanner_1', [300, 250], 'div-gpt-ad-elincorrecto-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Header_Chico', [240, 90], 'div-gpt-ad-elincorrecto-240x90').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/LeaderBoard', [728, 90], 'div-gpt-ad-elincorrecto-728x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/La_Sopa/Floating_3ros', 'div-gpt-ad-elincorrecto-floating_3ros').addService(googletag.pubads());";						
					break;
					case "videos-2":
						$name_sectionDFP="Videos";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Videos/BoxBanner_1', [300, 250], 'div-gpt-ad-videos-2-300x250-1').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Videos/Header_Chico', [240, 90], 'div-gpt-ad-videos-2-240x90').addService(googletag.pubads());
					...
					case "poptimizate":
						$name_sectionDFP="Homepage";
						$cod_slots="googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Header_Chico', [240, 90], 'div-gpt-ad-poptimizate-240x90').addService(googletag.pubads());
									googletag.defineOutOfPageSlot('/".$netDFP."/".$name_feedDFP."/Homepage/Floating_3ros', 'div-gpt-ad-poptimizate-floating_3ros').addService(googletag.pubads());
									googletag.defineSlot('/".$netDFP."/".$name_feedDFP."/Homepage/LeaderBoard', [728, 90], 'div-gpt-ad-poptimizate-728x90').addService(googletag.pubads());";
					break;
					case "app":
						$name_sectionDFP="Homepage";
