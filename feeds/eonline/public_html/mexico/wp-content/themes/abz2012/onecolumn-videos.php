...
function getTopVideos_CE() {
  addScriptTag("topVideos_CE", "http://api.brightcove.com/services/library?command=find_playlist_by_id&playlist_id=<?=$playlist_CE?>&media_delivery=http&token=<?php echo TOKEN; ?>", "response_CE");
}
...
function response_CE(jsonData) {
  //output the query
  var q = document.getElementById("qDiv_CE");
  var s = document.getElementById("topVideos_CE");

     traer_data_2("resp_CE", jsonData);

  $('#videoCE').tinycarousel();
        ...
        <div class="cont_one-clumn">
          <h2 style="color:<?php echo cat_color('videos-2');?>; margin-bottom:20px;">VIDEOS</h2>
				...
				<div class="super-snipe_lightblue franja"><h2>THE ROYALS</h2></div>
                 <div id="carrousel_RY" class="fondoFranja">
				 ...
				 <!-- <div class="super-snipe_green franja"><h2>CHICA E! México - El Reality</h2></div>
                 <div id="carrousel_CE" class="fondoFranja">
                      <div class="video-landing-main-content" id="videoCE" style="position:relative;">
                          <a class="buttons prev" href="#">&#60;</a>
                          <p id="qDiv_CE"></p>
                          <div class="viewport">
                            <ul class="overview" id="resp_CE" ><img src="/varios/assets/ajax-loading_ch2.gif" style="margin:auto;"/></ul>
                          </div>
                          <a class="buttons next" href="#">&#62;</a>
                      </div>
                  </div> -->
