...
<article id="imperdible" class="col-sm-4 col-xs-12 grid-item">
	<h3 id="titulo_imperdible"><a href="/<?php echo NAMEFEED;?>/category/imperdible/" title="Ver todas las entradas en Imperdible" rel="category tag" style="text-decoration:none;">¡IMPERDIBLE!</a></h3>
	 <?
	query_posts( 'category_name=imperdible&posts_per_page=5&orderby=date&order=DESC' );
	$p=1;
