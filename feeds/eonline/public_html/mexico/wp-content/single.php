...
<?php endif; ?>
				...
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Entrada anterior link', 'twentyten' ) . '</span> %title' ); ?></div>
					<div class="nav-next"><?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Proxima entrada link', 'twentyten' ) . '</span>' ); ?></div>
				</div><!-- #nav-below -->
