...
class PHPExcel_Cell
{
	...
	public function isInRange($pRange = 'A1:A1')
	{
     ...
     public static function addCellCoordinates($pCoordinateString = 'A1', $pColumnAdd = 0, $pRowAdd = 0) {
     		// Create absolute coordinate
     		//echo $pCoordinateString."+".$pColumnAdd.",".$pRowAdd; 
	    	list($column, $row) = PHPExcel_Cell::coordinateFromString($pCoordinateString);
     		...
     		//echo " -column:".$column."- ";
     		$row += $pRowAdd;
     		//echo "=".PHPExcel_Cell::stringFromColumnIndex($column-1).$row."<br>";
     		return PHPExcel_Cell::stringFromColumnIndex($column-1).$row; 		
     }
