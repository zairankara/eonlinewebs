<?php
/**
 * bcls-proxy.produccion - proxy for Brightcove RESTful APIs
...
$data = array();
$client_id     = 'e873c013-866d-484c-95be-b0f8c4eae686';
$client_secret = 'LenuP3hNfxAoOEUcQ9ceurVxMXQE5o6kyKYDgyYtpwOqPdO4mC_djMJ7cfwmVvc4jxnACnZFvp3QzgEOTRG4sQ';
...
if (strpos($_POST["url"], 'api.brightcove.com') == false && strpos($_POST["url"], 'data.brightcove.co.jp') == false && strpos($_POST["url"], 'data.brightcove.com') == false) {
      exit('{"ERROR":"Only requests to Brightcove APIs are accepted by this proxy"}'.$_POST["url"]);
