...
$dominio="http://br.eonline.com/wp-content/themes/abz2012/images/generica_blanca.jpg";
$dominio_face=$_GET["img"];
$titulo_face=$_GET["t"];
$desc_face=$_GET["d"];
$url_face=$_GET["url"];
$titulo="E! online Brasil";
$gallery=$_GET["gal"];
...
<html xmlns="http://www.w3.org/1999/xhtml"
	  ...
	  xmlns:fb="http://www.facebook.com/2008/fbml" itemscope itemtype="http://schema.org/Organization" lang="br">
	  <head>
	...
	<meta http-equiv="refresh" content="0.1; url=http://http://br.eonline.com/beta/?gallery=<?=$gallery?>"/>
