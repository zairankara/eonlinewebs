...
function getService()
{
  ...
  $service_account_email = 'e-and-353@e-abz-ga.iam.gserviceaccount.com';
  $key_file_location = '/home/eonline/public_html/varios/JSON/ga-API/GA-54ba5a460dfe.p12';

  // Create and configure a new client object.
  $client = new Google_Client();
  $client->setApplicationName("Andes");
...
file_put_contents('/home/eonline/public_html/varios/JSON/JSONanalytics/andes.json', $jsonData);
?>