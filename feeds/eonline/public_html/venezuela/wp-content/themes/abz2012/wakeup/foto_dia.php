<?php if(is_category("wakeup")){?>
	<h3 style="margin-top:8px;"><a href="<?php echo home_url( '/' ); ?>category/wakeup" class="widget-title" style="background-color:none !important; color:<?php echo cat_color("wakeup");?>">LA FOTO DEL DIA <span style="color:black"> WAKE UP</span></a></h3>
	<ul class="sidebar_300" style="display:block;margin-bottom:8px;">
		<?
		$querystring_cat= "tag=fotodeldiawakeup&showposts=1&order=DESC"; //ordenacion ascendente por fecha
		                   ...
		                   <a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>" style="float:left;" class="foto_TAG">
							...
							<div class="entry-content bg_darkgray" style="width: 284px; _width: 300px;float:left; margin-bottom:10px;">
								<span class="entry-text">
										<p style="text-transform:uppercase; color:<?php echo cat_color('wakeup');?>"><?php the_title(); ?></p>												
									</span>
								</div>
						<?
						$pt++; 
