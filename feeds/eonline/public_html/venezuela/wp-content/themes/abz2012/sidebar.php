...
?>
		...
		<div class="cont_sidebar">
						...
						<ul class="sidebar_300" >
						 <li>
						<?if(is_category("musica")):?>
						 <?php include(TEMPLATEPATH ."/soundcloud_VZ.php"); ?>
						 <?php endif; ?>
						 </li>
						 </ul>
						<!-- / SOUNDCLOUD -->
						...
						<?if(is_home()):?>
							...
							<!--<ul class="sidebar_300">
							<li>
								 <div class="widget_twitter" style="height:88px !important; background: url(<?php bloginfo('template_url')?>/images/vip_caracas.jpg) no-repeat;"></div>
								 <div class="widget_twitter_api">

							            <a class="twitter-timeline"  href="https://twitter.com/ztcaracas" data-widget-id="355744013715906561">Tweets por @ztcaracas.</a>
							            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
