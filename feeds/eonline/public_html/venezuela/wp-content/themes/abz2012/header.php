...
<!-- <?php if(is_home()){?>
	<meta http-equiv="refresh" content="0;url=http://la.eonline.com/venezuela/category/alfombraroja">
<?}?>-->
...
<body  id="venezuela" <?php body_class(); ?> <?if($title_post) echo ('data-title="'. utf8_decode($title_post).'"');?>>
