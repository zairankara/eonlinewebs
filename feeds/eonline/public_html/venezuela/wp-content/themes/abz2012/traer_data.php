...
switch ($pid) {
	case 1:
		$nombre="Abril";
		$desc="<p>La protagonista de nuestra historia transita su adolescencia llena de dudas y contradicciones. Toca la guitarra y canta muy bien. Se encuentra en una búsqueda permanente de su propia identidad, y de sus deseos.  Amante del longboard, lo usa como medio de locomoción.</p> 
		
		<p>Es intrépida, apasionada, impulsiva y muy talentosa. Se juega sin dudarlo por lo que quiere. La música, el arte, es lo que da sentido a su existencia. Cuando se entera de la herencia dejada por su padre, una vieja Estación de bomberos, ve en este espacio la posibilidad de armar un lugar para el arte y, sobre todo, para que sus sueños se puedan expresar y cumplir. Esto es lo que va a perseguir Abril a lo largo de toda la historia.</p>";
		break;
	case 2:
		$nombre="Marco";
		$desc="<p>(MEXICO): Es el “hermanastro” de Abril. Novio de Leticia. Marco parece un chico independiente y desenvuelto pero en el fondo, vive a la sombra de su padre, quien lo carga de paradigmas para lograr el Éxito. Siguiendo el “deber ser”, Marco se recibió de arquitecto. Pero esto está lejos de lo que realmente a él le gusta: la música. Conocer a Abril cambiará su vida para siempre, se atreverá a enfrentar su miedos y, por fin, a empezar el camino de lo que ama.</p>";
		break;
	case 3:
		$nombre="Leticia";
	...
	case 7:
		$nombre="Celeste";
		$desc="<p>Celeste: es la gran amiga de Abril. Baterista. Desafiante, positiva, alegre y decidida siempre a salir adelante con las ideas que CREE más justas.</p>
		<p>Conocer a Lucas cambiará su vida, pero la relación con él no será nada fácil, a ambos les costará reconocer lo que les pasa.  Además se cruzará en su camino Bruno,  un director de teatro que se acercará para alquilar la sala,  que complicará todavía más sus dificultades con el amor.</p>";
		break;
	case 8:
		$nombre="Alexis";
	...
	case 17:
		$nombre="Yahir";
		$desc="<p>Yahir: Entra en “Estación colectiva”. Muchos lo miran con cierta desconfianza, pero nadie puede negar que tiene un gran talento. En realdiad, Yahir es un infiltrado. Tiene personalidad obsesvia y calculadora. Bastante inadvertido pasa informacion a Leticia. Juega de lobo con piel de cordero.</p>";
		break;
	default:
		# code...
		break;
...
echo '
	...
	<div class="content-wakeup">
		<div class="columna_izq">
			<img src="http://la.eonline.com/experience/ms_wakeup/personajes/'.$pid.'.jpg">
		</div>
