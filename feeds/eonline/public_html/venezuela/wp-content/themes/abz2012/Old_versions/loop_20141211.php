		...
		if( is_home() || is_front_page()){?>
				...
				<?php }elseif(is_category()){?>
					...
					<?if(is_category("alfombraroja")){?>
						...
						<div id="loamoloodio">
							<iframe src="http://la.eonline.com/experience/redcarpetseason/loamoloodio/VZ/index.php" width="630" height="740" scrolling="no" style="overflow: hidden; border: none;"></iframe>
					...
					<?if(is_category("copadelmundo")){?>
						...
						<div id="copadelmundo">
							<iframe src="http://la.eonline.com/experience/loamoloodioMundial/VZ/index.php" width="630" height="830" scrolling="no" style="overflow: hidden; border: none;"></iframe>
						</div>
					...
					<?if(is_category("efashionblogger")){?>
						...
						.zona_banner_toppost{
							background: url(http://la.eonline.com/experience/fashion-blogger-ve/cab.jpg) bottom no-repeat;
							width: 630px;
							height: 47px;
							float: left;
						...
						<div id="nuevo_fashion">
							<iframe src="http://la.eonline.com/experience/fashion-blogger-ve/index.php" width="630" height="730" scrolling="no" style="overflow: hidden; border: none;"></iframe>
						</div>
