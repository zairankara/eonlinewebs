...
<?php //get_sidebar('left'); ?>
                ...
                <div class="col-md-12 col-lg-<?php echo $main_column_size;?> content-area" id="main-column">
					<main id="main" class="site-main" role="main">
						...
						<?php if (have_posts()) { ?>
                            ...
                            while (have_posts()) {
                                ...
                                //if( is_category("efashionblogger") && $i==1 ) include ( $_SERVER["DOCUMENT_ROOT"].'/common/loamoloodio/loamoloodio_EFB_vz.php');
