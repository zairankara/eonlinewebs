...
<?php 
		...
		while ( have_posts() ) : the_post(); ?>
						...
						<!--<?php if ( is_home() && $i==0 ){?>
								...
								<a href="http://www.eonlineexperiences.com/avengers/LA/" target="_blank"><img src="<?php bloginfo('template_url')?>/images/comunes/toppost_VEN.jpg" alt="" width="590" height="116" border="0"></a></div>
						<?}?>-->
						...
						<!--<?php if ( !is_home() && is_category("alfombraroja") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_gobe_VEN_3.gif" alt="" width="593" height="63" border="0"></div>
						<?}?>-->
						...
						$ruta_cache=$_SERVER["DOCUMENT_ROOT"]."venezuela/wp-content/cache/";
						...
						?>
								<?php if (is_home() && $i==0 ){?>
										  ...
										  <div style="z-index:1; margin-left:10px; margin-bottom:10px; width:590px; height:172px; background: url(http://la.eonline.com/venezuela/wp-content/themes/E-online/images/comunes/counter_nuevo.jpg) no-repeat; border:0px solid red; position:relative; ">
						...
						<script type='text/javascript'><!--// <![CDATA[
						    OA_show(42);
						// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=2bed9fa'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=42&amp;n=2bed9fa' /></a></noscript>
						</div>
						<?}?>
						<!-- ADSERVER TOPPOST-->
						...
						<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
						 <script type='text/javascript'><!--// <![CDATA[
						    OA_show(85);
						// ]]> --></script><noscript><a target='_blank' href='http://adsrv01.eonlinelatinola.com/www/delivery/ck.php?n=0090b50'><img border='0' alt='' src='http://adsrv01.eonlinelatinola.com/www/delivery/avw.php?zoneid=85&amp;n=0090b50' /></a></noscript>
						</div>
						<?}?>
						 <!--  ADSERVER TOPPOST-->
						...
						<!-- <?php if ( !is_home() && is_category("emmy") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_emmy_VEN.gif" alt="" width="593" height="64" border="0"></div>
						<?}?> 
						<?php if ( !is_home() && is_category("grammy") && $i==0 ){?>
								<div style="margin-top:10px; margin-left:10px; margin-bottom:10px">
								<img src="<?php bloginfo('template_url')?>/images/banners/auspicio_gobe_VEN.gif" alt="" width="593" height="64" border="0"></div>
						<?}?> -->
